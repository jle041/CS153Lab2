...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
   b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  12:	00 
  13:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
  1a:	e8 6b 03 00 00       	call   38a <open>
  1f:	85 c0                	test   %eax,%eax
  21:	0f 88 c3 00 00 00    	js     ea <main+0xea>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  32:	e8 8b 03 00 00       	call   3c2 <dup>
  dup(0);  // stderr
  37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3e:	e8 7f 03 00 00       	call   3c2 <dup>
  43:	90                   	nop
  44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  for(;;){
    printf(1, "init: starting sh\n");
  48:	c7 44 24 04 0e 08 00 	movl   $0x80e,0x4(%esp)
  4f:	00 
  50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  57:	e8 44 04 00 00       	call   4a0 <printf>
    pid = fork();
  5c:	e8 d9 02 00 00       	call   33a <fork>
    if(pid < 0){
  61:	85 c0                	test   %eax,%eax
    pid = fork();
  63:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  65:	78 2f                	js     96 <main+0x96>
      printf(1, "init: fork failed\n");
      exit(1);
    }
    if(pid == 0){
  67:	74 4d                	je     b6 <main+0xb6>
  ...
  70:	89 34 24             	mov    %esi,(%esp)
  73:	e8 d2 02 00 00       	call   34a <wait>
  78:	85 c0                	test   %eax,%eax
  7a:	78 cc                	js     48 <main+0x48>
  7c:	39 d8                	cmp    %ebx,%eax
  7e:	74 c8                	je     48 <main+0x48>
      printf(1, "zombie!\n");
  80:	c7 44 24 04 4d 08 00 	movl   $0x84d,0x4(%esp)
  87:	00 
  88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8f:	e8 0c 04 00 00       	call   4a0 <printf>
  94:	eb da                	jmp    70 <main+0x70>
      printf(1, "init: fork failed\n");
  96:	c7 44 24 04 21 08 00 	movl   $0x821,0x4(%esp)
  9d:	00 
  9e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  a5:	e8 f6 03 00 00       	call   4a0 <printf>
      exit(1);
  aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b1:	e8 8c 02 00 00       	call   342 <exit>
      exec("sh", argv);
  b6:	c7 44 24 04 d8 0a 00 	movl   $0xad8,0x4(%esp)
  bd:	00 
  be:	c7 04 24 34 08 00 00 	movl   $0x834,(%esp)
  c5:	e8 b8 02 00 00       	call   382 <exec>
      printf(1, "init: exec sh failed\n");
  ca:	c7 44 24 04 37 08 00 	movl   $0x837,0x4(%esp)
  d1:	00 
  d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d9:	e8 c2 03 00 00       	call   4a0 <printf>
      exit(1);
  de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e5:	e8 58 02 00 00       	call   342 <exit>
    mknod("console", 1, 1);
  ea:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  f1:	00 
  f2:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  f9:	00 
  fa:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
 101:	e8 8c 02 00 00       	call   392 <mknod>
    open("console", O_RDWR);
 106:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 10d:	00 
 10e:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
 115:	e8 70 02 00 00       	call   38a <open>
 11a:	e9 08 ff ff ff       	jmp    27 <main+0x27>
 11f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	e8 eb fe ff ff       	call   36a <write>
  while(--i >= 0)
 ...
 4ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4e3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 4e6:	e8 7f fe ff ff       	call   36a <write>
 ...
 556:	e8 0f fe ff ff       	call   36a <write>
        putc(fd, c);
 ...
 570:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 573:	e8 f2 fd ff ff       	call   36a <write>
  for(i = 0; fmt[i]; i++){
 ...
 600:	e8 65 fd ff ff       	call   36a <write>
        while(*s != 0){
 ...
 630:	e8 35 fd ff ff       	call   36a <write>
 ...
 680:	e8 e5 fc ff ff       	call   36a <write>
        ap++;
 ...
 691:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 6d7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6d9:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 6de:	5b                   	pop    %ebx
 6df:	5e                   	pop    %esi
 6e0:	5f                   	pop    %edi
 ...
 6ff:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 702:	a3 e0 0a 00 00       	mov    %eax,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 1d e0 0a 00 00    	mov    0xae0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 76b:	3b 15 e0 0a 00 00    	cmp    0xae0,%edx
 ...
 78a:	e8 43 fc ff ff       	call   3d2 <sbrk>
  if(p == (char*)-1)
 ...
 79d:	e8 ee fe ff ff       	call   690 <free>
  return freep;
 7a2:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 7c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 e0 0a 00 00    	mov    %edx,0xae0
      return (void*)(p + 1);
 ...
 7dc:	eb e9                	jmp    7c7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7de:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 7e5:	0a 00 00 
    base.s.size = 0;
 7e8:	ba e4 0a 00 00       	mov    $0xae4,%edx
    base.s.ptr = freep = prevp = &base;
 7ed:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7f4:	0a 00 00 
    base.s.size = 0;
 7f7:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7fe:	00 00 00 
