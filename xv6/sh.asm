...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      28:	e8 fd 0d 00 00       	call   e2a <open>
    ...
    if(fork1() == 0)
      runcmd(parsecmd(buf));
    wait(&status);
      31:	8d 5c 24 1c          	lea    0x1c(%esp),%ebx
      35:	eb 17                	jmp    4e <main+0x4e>
      37:	90                   	nop
    if(fork1() == 0)
      38:	e8 43 01 00 00       	call   180 <fork1>
      3d:	85 c0                	test   %eax,%eax
      3f:	90                   	nop
      40:	0f 84 95 00 00 00    	je     db <main+0xdb>
    wait(&status);
      46:	89 1c 24             	mov    %ebx,(%esp)
      49:	e8 9c 0d 00 00       	call   dea <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
      4e:	c7 44 24 04 64 00 00 	movl   $0x64,0x4(%esp)
      55:	00 
      56:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
      5d:	e8 8e 00 00 00       	call   f0 <getcmd>
      62:	85 c0                	test   %eax,%eax
      64:	78 5c                	js     c2 <main+0xc2>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      66:	80 3d 40 19 00 00 63 	cmpb   $0x63,0x1940
      6d:	75 c9                	jne    38 <main+0x38>
      6f:	80 3d 41 19 00 00 64 	cmpb   $0x64,0x1941
      76:	75 c0                	jne    38 <main+0x38>
      78:	80 3d 42 19 00 00 20 	cmpb   $0x20,0x1942
      7f:	75 b7                	jne    38 <main+0x38>
      buf[strlen(buf)-1] = 0;  // chop \n
      81:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
      88:	e8 b3 0b 00 00       	call   c40 <strlen>
      if(chdir(buf+3) < 0)
      8d:	c7 04 24 43 19 00 00 	movl   $0x1943,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      94:	c6 80 3f 19 00 00 00 	movb   $0x0,0x193f(%eax)
      if(chdir(buf+3) < 0)
      9b:	e8 ba 0d 00 00       	call   e5a <chdir>
      a0:	85 c0                	test   %eax,%eax
      a2:	79 aa                	jns    4e <main+0x4e>
        printf(2, "cannot cd %s\n", buf+3);
      a4:	c7 44 24 08 43 19 00 	movl   $0x1943,0x8(%esp)
      ab:	00 
      ac:	c7 44 24 04 51 13 00 	movl   $0x1351,0x4(%esp)
      b3:	00 
      b4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      bb:	e8 80 0e 00 00       	call   f40 <printf>
      c0:	eb 8c                	jmp    4e <main+0x4e>
  }
  exit(1);
      c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      c9:	e8 14 0d 00 00       	call   de2 <exit>
      close(fd);
      ce:	89 04 24             	mov    %eax,(%esp)
      d1:	e8 3c 0d 00 00       	call   e12 <close>
      break;
      d6:	e9 56 ff ff ff       	jmp    31 <main+0x31>
      runcmd(parsecmd(buf));
      db:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
      e2:	e8 59 0a 00 00       	call   b40 <parsecmd>
      e7:	89 04 24             	mov    %eax,(%esp)
      ea:	e8 b1 00 00 00       	call   1a0 <runcmd>
      ef:	90                   	nop
...
000000f0 <getcmd>:
{
      ...
      fb:	8b 75 0c             	mov    0xc(%ebp),%esi
  printf(2, "$ ");
      fe:	c7 44 24 04 a8 12 00 	movl   $0x12a8,0x4(%esp)
     105:	00 
     106:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     10d:	e8 2e 0e 00 00       	call   f40 <printf>
  memset(buf, 0, nbuf);
     112:	89 74 24 08          	mov    %esi,0x8(%esp)
     116:	89 1c 24             	mov    %ebx,(%esp)
     119:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     120:	00 
     121:	e8 4a 0b 00 00       	call   c70 <memset>
  gets(buf, nbuf);
     126:	89 74 24 04          	mov    %esi,0x4(%esp)
     12a:	89 1c 24             	mov    %ebx,(%esp)
     12d:	e8 9e 0b 00 00       	call   cd0 <gets>
  if(buf[0] == 0) // EOF
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	c7 44 24 04 45 13 00 	movl   $0x1345,0x4(%esp)
     160:	00 
     161:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     168:	89 44 24 08          	mov    %eax,0x8(%esp)
     16c:	e8 cf 0d 00 00       	call   f40 <printf>
  exit(1);
     171:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     178:	e8 65 0c 00 00       	call   de2 <exit>
...
fork1(void)
{
  ...
  pid = fork();
     186:	e8 4f 0c 00 00       	call   dda <fork>
  if(pid == -1)
  ...
  return pid;
     ...
     191:	c3                   	ret    
    panic("fork");
     192:	c7 04 24 ab 12 00 00 	movl   $0x12ab,(%esp)
...
000001a0 <runcmd>:
{
  ...
  if(cmd == 0)
     ...
     1ac:	74 68                	je     216 <runcmd+0x76>
  switch(cmd->type){
     1ae:	83 3b 05             	cmpl   $0x5,(%ebx)
     1b1:	0f 87 fd 00 00 00    	ja     2b4 <runcmd+0x114>
     1b7:	8b 03                	mov    (%ebx),%eax
     1b9:	ff 24 85 60 13 00 00 	jmp    *0x1360(,%eax,4)
    if(pipe(p) < 0)
     1c0:	8d 45 f0             	lea    -0x10(%ebp),%eax
     1c3:	89 04 24             	mov    %eax,(%esp)
     1c6:	e8 2f 0c 00 00       	call   dfa <pipe>
     1cb:	85 c0                	test   %eax,%eax
     1cd:	0f 88 ed 00 00 00    	js     2c0 <runcmd+0x120>
    if(fork1() == 0){
     1d3:	e8 a8 ff ff ff       	call   180 <fork1>
     1d8:	85 c0                	test   %eax,%eax
     1da:	0f 84 44 01 00 00    	je     324 <runcmd+0x184>
    if(fork1() == 0){
     1e0:	e8 9b ff ff ff       	call   180 <fork1>
     1e5:	85 c0                	test   %eax,%eax
     1e7:	0f 84 ff 00 00 00    	je     2ec <runcmd+0x14c>
    close(p[0]);
     1ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    wait(&status);
     1f0:	8d 5d ec             	lea    -0x14(%ebp),%ebx
    close(p[0]);
     1f3:	89 04 24             	mov    %eax,(%esp)
     1f6:	e8 17 0c 00 00       	call   e12 <close>
    close(p[1]);
     1fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 0c 0c 00 00       	call   e12 <close>
    wait(&status);
     206:	89 1c 24             	mov    %ebx,(%esp)
     209:	e8 dc 0b 00 00       	call   dea <wait>
    wait(&status);
     20e:	89 1c 24             	mov    %ebx,(%esp)
     211:	e8 d4 0b 00 00       	call   dea <wait>
      exit(1);
     216:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     21d:	e8 c0 0b 00 00       	call   de2 <exit>
    if(fork1() == 0)
     222:	e8 59 ff ff ff       	call   180 <fork1>
     227:	85 c0                	test   %eax,%eax
     229:	75 eb                	jne    216 <runcmd+0x76>
     22b:	90                   	nop
     22c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     230:	eb 77                	jmp    2a9 <runcmd+0x109>
    if(ecmd->argv[0] == 0)
     232:	8b 43 04             	mov    0x4(%ebx),%eax
     235:	85 c0                	test   %eax,%eax
     237:	74 dd                	je     216 <runcmd+0x76>
    exec(ecmd->argv[0], ecmd->argv);
     239:	8d 53 04             	lea    0x4(%ebx),%edx
     23c:	89 54 24 04          	mov    %edx,0x4(%esp)
     240:	89 04 24             	mov    %eax,(%esp)
     243:	e8 da 0b 00 00       	call   e22 <exec>
    ...
    break;
     263:	eb b1                	jmp    216 <runcmd+0x76>
    if(fork1() == 0)
     265:	e8 16 ff ff ff       	call   180 <fork1>
     26a:	85 c0                	test   %eax,%eax
     26c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     270:	74 37                	je     2a9 <runcmd+0x109>
    wait(&status);
     272:	8d 45 ec             	lea    -0x14(%ebp),%eax
     275:	89 04 24             	mov    %eax,(%esp)
     278:	e8 6d 0b 00 00       	call   dea <wait>
    runcmd(lcmd->right);
     27d:	8b 43 08             	mov    0x8(%ebx),%eax
     280:	89 04 24             	mov    %eax,(%esp)
     283:	e8 18 ff ff ff       	call   1a0 <runcmd>
    close(rcmd->fd);
     288:	8b 43 14             	mov    0x14(%ebx),%eax
     28b:	89 04 24             	mov    %eax,(%esp)
     28e:	e8 7f 0b 00 00       	call   e12 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     293:	8b 43 10             	mov    0x10(%ebx),%eax
     296:	89 44 24 04          	mov    %eax,0x4(%esp)
     29a:	8b 43 08             	mov    0x8(%ebx),%eax
     29d:	89 04 24             	mov    %eax,(%esp)
     2a0:	e8 85 0b 00 00       	call   e2a <open>
     2a5:	85 c0                	test   %eax,%eax
     2a7:	78 23                	js     2cc <runcmd+0x12c>
      runcmd(bcmd->cmd);
     2a9:	8b 43 04             	mov    0x4(%ebx),%eax
     2ac:	89 04 24             	mov    %eax,(%esp)
     2af:	e8 ec fe ff ff       	call   1a0 <runcmd>
    panic("runcmd");
     2b4:	c7 04 24 b0 12 00 00 	movl   $0x12b0,(%esp)
     2bb:	e8 90 fe ff ff       	call   150 <panic>
      panic("pipe");
     2c0:	c7 04 24 d7 12 00 00 	movl   $0x12d7,(%esp)
     2c7:	e8 84 fe ff ff       	call   150 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2cc:	8b 43 08             	mov    0x8(%ebx),%eax
     2cf:	c7 44 24 04 c7 12 00 	movl   $0x12c7,0x4(%esp)
     2d6:	00 
     2d7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     2de:	89 44 24 08          	mov    %eax,0x8(%esp)
     2e2:	e8 59 0c 00 00       	call   f40 <printf>
     2e7:	e9 2a ff ff ff       	jmp    216 <runcmd+0x76>
      close(0);
     2ec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
     2f3:	e8 1a 0b 00 00       	call   e12 <close>
      dup(p[0]);
     2f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
     2fb:	89 04 24             	mov    %eax,(%esp)
     2fe:	e8 5f 0b 00 00       	call   e62 <dup>
      close(p[0]);
     303:	8b 45 f0             	mov    -0x10(%ebp),%eax
     306:	89 04 24             	mov    %eax,(%esp)
     309:	e8 04 0b 00 00       	call   e12 <close>
      close(p[1]);
     30e:	8b 45 f4             	mov    -0xc(%ebp),%eax
     311:	89 04 24             	mov    %eax,(%esp)
     314:	e8 f9 0a 00 00       	call   e12 <close>
      runcmd(pcmd->right);
     319:	8b 43 08             	mov    0x8(%ebx),%eax
     31c:	89 04 24             	mov    %eax,(%esp)
     31f:	e8 7c fe ff ff       	call   1a0 <runcmd>
      close(1);
     324:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     32b:	e8 e2 0a 00 00       	call   e12 <close>
      dup(p[1]);
     330:	8b 45 f4             	mov    -0xc(%ebp),%eax
     333:	89 04 24             	mov    %eax,(%esp)
     336:	e8 27 0b 00 00       	call   e62 <dup>
      close(p[0]);
     33b:	8b 45 f0             	mov    -0x10(%ebp),%eax
     33e:	89 04 24             	mov    %eax,(%esp)
     341:	e8 cc 0a 00 00       	call   e12 <close>
      close(p[1]);
     346:	8b 45 f4             	mov    -0xc(%ebp),%eax
     349:	89 04 24             	mov    %eax,(%esp)
     34c:	e8 c1 0a 00 00       	call   e12 <close>
      runcmd(pcmd->left);
     351:	8b 43 04             	mov    0x4(%ebx),%eax
     354:	89 04 24             	mov    %eax,(%esp)
     357:	e8 44 fe ff ff       	call   1a0 <runcmd>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  return cmd;
     ...
     76a:	e8 e1 f9 ff ff       	call   150 <panic>
     76f:	90                   	nop
...
parseexec(char **ps, char *es)
{
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     838:	e8 13 f9 ff ff       	call   150 <panic>
  ...
  return ret;
     ...
     881:	e8 ca f8 ff ff       	call   150 <panic>
...
000009d0 <parseblock>:
{
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("syntax - missing )");
     ...
     a80:	e8 cb f6 ff ff       	call   150 <panic>
...
00000b40 <parsecmd>:
{
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     bb4:	e8 97 f5 ff ff       	call   150 <panic>
     ...
     cd5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     cf3:	e8 0a 01 00 00       	call   e02 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d46:	e8 df 00 00 00       	call   e2a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d5b:	e8 e2 00 00 00       	call   e42 <fstat>
  close(fd);
     d60:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d63:	89 c6                	mov    %eax,%esi
  close(fd);
     d65:	e8 a8 00 00 00       	call   e12 <close>
  return r;
...
00000dfa <pipe>:
SYSCALL(pipe)
     dfa:	b8 04 00 00 00       	mov    $0x4,%eax
     dff:	cd 40                	int    $0x40
     e01:	c3                   	ret    

00000e02 <read>:
SYSCALL(read)
     e02:	b8 05 00 00 00       	mov    $0x5,%eax
     e07:	cd 40                	int    $0x40
     e09:	c3                   	ret    

00000e0a <write>:
SYSCALL(write)
     e0a:	b8 10 00 00 00       	mov    $0x10,%eax
     e0f:	cd 40                	int    $0x40
     e11:	c3                   	ret    

00000e12 <close>:
SYSCALL(close)
     e12:	b8 15 00 00 00       	mov    $0x15,%eax
     e17:	cd 40                	int    $0x40
     e19:	c3                   	ret    
...
00000e22 <exec>:
SYSCALL(exec)
     e22:	b8 07 00 00 00       	mov    $0x7,%eax
     e27:	cd 40                	int    $0x40
     e29:	c3                   	ret    

00000e2a <open>:
SYSCALL(open)
     e2a:	b8 0f 00 00 00       	mov    $0xf,%eax
     e2f:	cd 40                	int    $0x40
     e31:	c3                   	ret    

00000e32 <mknod>:
SYSCALL(mknod)
     e32:	b8 11 00 00 00       	mov    $0x11,%eax
     e37:	cd 40                	int    $0x40
     e39:	c3                   	ret    

00000e3a <unlink>:
SYSCALL(unlink)
     e3a:	b8 12 00 00 00       	mov    $0x12,%eax
     e3f:	cd 40                	int    $0x40
     e41:	c3                   	ret    

00000e42 <fstat>:
SYSCALL(fstat)
     e42:	b8 08 00 00 00       	mov    $0x8,%eax
     e47:	cd 40                	int    $0x40
     e49:	c3                   	ret    

00000e4a <link>:
SYSCALL(link)
     e4a:	b8 13 00 00 00       	mov    $0x13,%eax
     e4f:	cd 40                	int    $0x40
     e51:	c3                   	ret    

00000e52 <mkdir>:
SYSCALL(mkdir)
     e52:	b8 14 00 00 00       	mov    $0x14,%eax
     e57:	cd 40                	int    $0x40
     e59:	c3                   	ret    
...
00000e62 <dup>:
SYSCALL(dup)
     e62:	b8 0a 00 00 00       	mov    $0xa,%eax
     e67:	cd 40                	int    $0x40
     e69:	c3                   	ret    

00000e6a <getpid>:
SYSCALL(getpid)
     e6a:	b8 0b 00 00 00       	mov    $0xb,%eax
     e6f:	cd 40                	int    $0x40
     e71:	c3                   	ret    

00000e72 <sbrk>:
SYSCALL(sbrk)
     e72:	b8 0c 00 00 00       	mov    $0xc,%eax
     e77:	cd 40                	int    $0x40
     e79:	c3                   	ret    

00000e7a <sleep>:
SYSCALL(sleep)
     e7a:	b8 0d 00 00 00       	mov    $0xd,%eax
     e7f:	cd 40                	int    $0x40
     e81:	c3                   	ret    

00000e82 <uptime>:
SYSCALL(uptime)
     e82:	b8 0e 00 00 00       	mov    $0xe,%eax
     e87:	cd 40                	int    $0x40
     e89:	c3                   	ret    

00000e8a <setpriority>:
SYSCALL(setpriority)
     e8a:	b8 17 00 00 00       	mov    $0x17,%eax
     e8f:	cd 40                	int    $0x40
     e91:	c3                   	ret    

00000e92 <getpriority>:
SYSCALL(getpriority)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  write(fd, &c, 1);
     ...
     f1a:	e8 eb fe ff ff       	call   e0a <write>
  while(--i >= 0)
     ...
     f4e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  write(fd, &c, 1);
     f86:	e8 7f fe ff ff       	call   e0a <write>
  ...
  write(fd, &c, 1);
     ...
     ff6:	e8 0f fe ff ff       	call   e0a <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    1013:	e8 f2 fd ff ff       	call   e0a <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    10a0:	e8 65 fd ff ff       	call   e0a <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    10d0:	e8 35 fd ff ff       	call   e0a <write>
  ...
  write(fd, &c, 1);
    ...
    1120:	e8 e5 fc ff ff       	call   e0a <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    122a:	e8 43 fc ff ff       	call   e72 <sbrk>
  if(p == (char*)-1)
