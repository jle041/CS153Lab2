  ...
  55:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  70:	e8 ab ff ff ff       	call   20 <printf>
  75:	eb 12                	jmp    89 <forktest+0x39>
  77:	90                   	nop
    if(pid == 0)
  78:	0f 84 a6 00 00 00    	je     124 <forktest+0xd4>
  for(n=0; n<N; n++){
  ...
  94:	8d 75 f4             	lea    -0xc(%ebp),%esi
  97:	74 18                	je     b1 <forktest+0x61>
  99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(wait(&status) < 0){
  a0:	89 34 24             	mov    %esi,(%esp)
  a3:	e8 d2 02 00 00       	call   37a <wait>
  a8:	85 c0                	test   %eax,%eax
  aa:	78 64                	js     110 <forktest+0xc0>
  for(; n > 0; n--){
  ac:	83 eb 01             	sub    $0x1,%ebx
  af:	75 ef                	jne    a0 <forktest+0x50>
  if(wait(&status) != -1){
  ...
  ff:	e8 96 02 00 00       	call   39a <write>
    exit(1);
 ...
 14b:	e8 22 02 00 00       	call   372 <exit>
