...
int main(int argc, char *argv[])
{
  ...
  printf(1, "\n This program tests the correctness of your lab#1\n");
   d:	c7 44 24 04 c4 0c 00 	movl   $0xcc4,0x4(%esp)
  14:	00 
  ...
  41:	c7 44 24 04 f8 0c 00 	movl   $0xcf8,0x4(%esp)
  48:	00 
...
int exitWait(void) {
 ...
 154:	e8 a9 04 00 00       	call   602 <exit>
	  printf(2, "\nError using fork\n");
 159:	c7 44 24 04 38 0d 00 	movl   $0xd38,0x4(%esp)
 160:	00 
...
int waitPid(void){
 ...
 1e2:	8d 5d e0             	lea    -0x20(%ebp),%ebx
      sleep(5);
 1e5:	e8 b0 04 00 00       	call   69a <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[3]);
 ...
 214:	e8 f9 03 00 00       	call   612 <waitpid>
      printf(1, "\n This is the child: Child# %d infant annhilated with status %d\n",ret_pid, exit_status);
 ...
 23f:	e8 56 04 00 00       	call   69a <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[1]);
 ...
 299:	e8 fc 03 00 00       	call   69a <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[2]);
 ...
 2c8:	e8 45 03 00 00       	call   612 <waitpid>
      printf(1, "\n This is the child: Child# %d infant annihilated with status %d\n",ret_pid, exit_status);
 2cd:	8b 55 e0             	mov    -0x20(%ebp),%edx
 2d0:	c7 44 24 04 80 0c 00 	movl   $0xc80,0x4(%esp)
 2d7:	00 
 ...
 2f3:	e8 a2 03 00 00       	call   69a <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[0]);
 ...
 34d:	e8 48 03 00 00       	call   69a <sleep>
      printf(1, "\n This is the parent: Now waiting for child with PID# %d\n",pid_a[4]);
 ...
 384:	c7 44 24 04 80 0c 00 	movl   $0xc80,0x4(%esp)
 38b:	00 
...
0000069a <sleep>:
SYSCALL(sleep)
 69a:	b8 0d 00 00 00       	mov    $0xd,%eax
 69f:	cd 40                	int    $0x40
 6a1:	c3                   	ret    

000006a2 <uptime>:
SYSCALL(uptime)
 6a2:	b8 0e 00 00 00       	mov    $0xe,%eax
 6a7:	cd 40                	int    $0x40
 6a9:	c3                   	ret    

000006aa <setpriority>:
SYSCALL(setpriority)
 6aa:	b8 17 00 00 00       	mov    $0x17,%eax
 6af:	cd 40                	int    $0x40
 6b1:	c3                   	ret    

000006b2 <getpriority>:
SYSCALL(getpriority)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6f9:	0f b6 92 52 0d 00 00 	movzbl 0xd52(%edx),%edx
  }while((x /= base) != 0);
 ...
 76e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 88f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 891:	b8 4b 0d 00 00       	mov    $0xd4b,%eax
...
free(void *ap)
{
 ...
 951:	a1 20 10 00 00       	mov    0x1020,%eax
{
 ...
 997:	89 10                	mov    %edx,(%eax)
  freep = p;
 999:	a3 20 10 00 00       	mov    %eax,0x1020
}
 99e:	5b                   	pop    %ebx
 99f:	5e                   	pop    %esi
 9a0:	5f                   	pop    %edi
 ...
 9bf:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 9c2:	a3 20 10 00 00       	mov    %eax,0x1020
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ec:	8b 1d 20 10 00 00    	mov    0x1020,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a29:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 a2b:	3b 15 20 10 00 00    	cmp    0x1020,%edx
 ...
 a5d:	e8 ee fe ff ff       	call   950 <free>
  return freep;
 a62:	8b 15 20 10 00 00    	mov    0x1020,%edx
 ...
 a84:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a87:	89 15 20 10 00 00    	mov    %edx,0x1020
      return (void*)(p + 1);
 ...
 a9c:	eb e9                	jmp    a87 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 a9e:	c7 05 20 10 00 00 24 	movl   $0x1024,0x1020
 aa5:	10 00 00 
    base.s.size = 0;
 aa8:	ba 24 10 00 00       	mov    $0x1024,%edx
    base.s.ptr = freep = prevp = &base;
 aad:	c7 05 24 10 00 00 24 	movl   $0x1024,0x1024
 ab4:	10 00 00 
    base.s.size = 0;
 ab7:	c7 05 28 10 00 00 00 	movl   $0x0,0x1028
 abe:	00 00 00 
