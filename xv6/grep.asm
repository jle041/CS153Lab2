...
printint(int fd, int xx, int base, int sgn)
{
 ...
 68a:	e8 eb fe ff ff       	call   57a <write>
  while(--i >= 0)
 ...
 6be:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 6f3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 6f6:	e8 7f fe ff ff       	call   57a <write>
 ...
 766:	e8 0f fe ff ff       	call   57a <write>
        putc(fd, c);
 ...
 780:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 783:	e8 f2 fd ff ff       	call   57a <write>
  for(i = 0; fmt[i]; i++){
 ...
 810:	e8 65 fd ff ff       	call   57a <write>
        while(*s != 0){
 ...
 840:	e8 35 fd ff ff       	call   57a <write>
 ...
 890:	e8 e5 fc ff ff       	call   57a <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 99a:	e8 43 fc ff ff       	call   5e2 <sbrk>
  if(p == (char*)-1)
