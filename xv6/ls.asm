...
00000100 <ls>:
{
 ...
 11a:	e8 db 04 00 00       	call   5fa <open>
 ...
 136:	e8 d7 04 00 00       	call   612 <fstat>
 ...
 1a1:	e8 3c 04 00 00       	call   5e2 <close>
}
 ...
 21f:	e8 ae 03 00 00       	call   5d2 <read>
 ...
 353:	e8 8a 02 00 00       	call   5e2 <close>
    return;
 ...
 4a5:	31 f6                	xor    %esi,%esi
{
 ...
 4c3:	e8 0a 01 00 00       	call   5d2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 516:	e8 df 00 00 00       	call   5fa <open>
  if(fd < 0)
 ...
 52b:	e8 e2 00 00 00       	call   612 <fstat>
  close(fd);
 530:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 533:	89 c6                	mov    %eax,%esi
  close(fd);
 535:	e8 a8 00 00 00       	call   5e2 <close>
  return r;
...
000005da <write>:
SYSCALL(write)
 5da:	b8 10 00 00 00       	mov    $0x10,%eax
 5df:	cd 40                	int    $0x40
 5e1:	c3                   	ret    

000005e2 <close>:
SYSCALL(close)
 5e2:	b8 15 00 00 00       	mov    $0x15,%eax
 5e7:	cd 40                	int    $0x40
 5e9:	c3                   	ret    

000005ea <kill>:
SYSCALL(kill)
 5ea:	b8 06 00 00 00       	mov    $0x6,%eax
 5ef:	cd 40                	int    $0x40
 5f1:	c3                   	ret    

000005f2 <exec>:
SYSCALL(exec)
 5f2:	b8 07 00 00 00       	mov    $0x7,%eax
 5f7:	cd 40                	int    $0x40
 5f9:	c3                   	ret    

000005fa <open>:
SYSCALL(open)
 5fa:	b8 0f 00 00 00       	mov    $0xf,%eax
 5ff:	cd 40                	int    $0x40
 601:	c3                   	ret    

00000602 <mknod>:
SYSCALL(mknod)
 602:	b8 11 00 00 00       	mov    $0x11,%eax
 607:	cd 40                	int    $0x40
 609:	c3                   	ret    

0000060a <unlink>:
SYSCALL(unlink)
 60a:	b8 12 00 00 00       	mov    $0x12,%eax
 60f:	cd 40                	int    $0x40
 611:	c3                   	ret    

00000612 <fstat>:
SYSCALL(fstat)
 612:	b8 08 00 00 00       	mov    $0x8,%eax
 617:	cd 40                	int    $0x40
 619:	c3                   	ret    

0000061a <link>:
SYSCALL(link)
 61a:	b8 13 00 00 00       	mov    $0x13,%eax
 61f:	cd 40                	int    $0x40
 621:	c3                   	ret    

00000622 <mkdir>:
SYSCALL(mkdir)
 622:	b8 14 00 00 00       	mov    $0x14,%eax
 627:	cd 40                	int    $0x40
 629:	c3                   	ret    

0000062a <chdir>:
SYSCALL(chdir)
 62a:	b8 09 00 00 00       	mov    $0x9,%eax
 62f:	cd 40                	int    $0x40
 631:	c3                   	ret    

00000632 <dup>:
SYSCALL(dup)
 632:	b8 0a 00 00 00       	mov    $0xa,%eax
 637:	cd 40                	int    $0x40
 639:	c3                   	ret    

0000063a <getpid>:
SYSCALL(getpid)
 63a:	b8 0b 00 00 00       	mov    $0xb,%eax
 63f:	cd 40                	int    $0x40
 641:	c3                   	ret    

00000642 <sbrk>:
SYSCALL(sbrk)
 642:	b8 0c 00 00 00       	mov    $0xc,%eax
 647:	cd 40                	int    $0x40
 649:	c3                   	ret    

0000064a <sleep>:
SYSCALL(sleep)
 64a:	b8 0d 00 00 00       	mov    $0xd,%eax
 64f:	cd 40                	int    $0x40
 651:	c3                   	ret    

00000652 <uptime>:
SYSCALL(uptime)
 652:	b8 0e 00 00 00       	mov    $0xe,%eax
 657:	cd 40                	int    $0x40
 659:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ea:	e8 eb fe ff ff       	call   5da <write>
  while(--i >= 0)
 ...
 71e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 753:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 756:	e8 7f fe ff ff       	call   5da <write>
 ...
 7c6:	e8 0f fe ff ff       	call   5da <write>
        putc(fd, c);
 ...
 7e0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 7e3:	e8 f2 fd ff ff       	call   5da <write>
  for(i = 0; fmt[i]; i++){
 ...
 870:	e8 65 fd ff ff       	call   5da <write>
        while(*s != 0){
 ...
 8a0:	e8 35 fd ff ff       	call   5da <write>
 ...
 8f0:	e8 e5 fc ff ff       	call   5da <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9fa:	e8 43 fc ff ff       	call   642 <sbrk>
  if(p == (char*)-1)
