...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	e8 eb fe ff ff       	call   38a <write>
  while(--i >= 0)
 ...
 4ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 503:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 506:	e8 7f fe ff ff       	call   38a <write>
 ...
 576:	e8 0f fe ff ff       	call   38a <write>
        putc(fd, c);
 ...
 590:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 593:	e8 f2 fd ff ff       	call   38a <write>
  for(i = 0; fmt[i]; i++){
 ...
 620:	e8 65 fd ff ff       	call   38a <write>
        while(*s != 0){
 ...
 650:	e8 35 fd ff ff       	call   38a <write>
 ...
 6a0:	e8 e5 fc ff ff       	call   38a <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7aa:	e8 43 fc ff ff       	call   3f2 <sbrk>
  if(p == (char*)-1)
