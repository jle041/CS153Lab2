...
8010005b:	e8 b0 41 00 00       	call   80104210 <initlock>
  bcache.head.next = &bcache.head;
...
8010009b:	80 
8010009c:	e8 3f 40 00 00       	call   801040e0 <initsleeplock>
...
80100161:	e8 8a 42 00 00       	call   801043f0 <release>
      acquiresleep(&b->lock);
80100166:	8d 43 0c             	lea    0xc(%ebx),%eax
80100169:	89 04 24             	mov    %eax,(%esp)
8010016c:	e8 af 3f 00 00       	call   80104120 <acquiresleep>
  struct buf *b;
...
801001b0:	e8 0b 40 00 00       	call   801041c0 <holdingsleep>
...
801001f1:	e8 ca 3f 00 00       	call   801041c0 <holdingsleep>
...
801001fd:	e8 7e 3f 00 00       	call   80104180 <releasesleep>
...
8010024f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100250:	e9 9b 41 00 00       	jmp    801043f0 <release>
    panic("brelse");
...
80100311:	e8 da 40 00 00       	call   801043f0 <release>
  ilock(ip);
...
8010032f:	e8 bc 40 00 00       	call   801043f0 <release>
        ilock(ip);
...
801003af:	e8 7c 3e 00 00       	call   80104230 <getcallerpcs>
...
801004fc:	e8 df 3f 00 00       	call   801044e0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100518:	00 
80100519:	e8 22 3f 00 00       	call   80104440 <memset>
...
80100636:	e8 b5 3d 00 00       	call   801043f0 <release>
  ilock(ip);
...
801006f3:	e8 f8 3c 00 00       	call   801043f0 <release>
}
...
80100827:	e8 c4 3b 00 00       	call   801043f0 <release>
  if(doprocdump) {
...
80100965:	e8 a6 38 00 00       	call   80104210 <initlock>
...
80100c01:	e8 5a 3a 00 00       	call   80104660 <strlen>
...
80100c12:	e8 49 3a 00 00       	call   80104660 <strlen>
...
80100ceb:	83 c0 74             	add    $0x74,%eax
80100cee:	89 04 24             	mov    %eax,(%esp)
80100cf1:	e8 2a 39 00 00       	call   80104620 <safestrcpy>
  curproc->pgdir = pgdir;
80100cf6:	8b 8d f0 fe ff ff    	mov    -0x110(%ebp),%ecx
  oldpgdir = curproc->pgdir;
80100cfc:	8b 77 04             	mov    0x4(%edi),%esi
  curproc->tf->eip = elf.entry;  // main
80100cff:	8b 47 20             	mov    0x20(%edi),%eax
  curproc->pgdir = pgdir;
...
80100d13:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d16:	8b 47 20             	mov    0x20(%edi),%eax
...
80100d65:	e8 a6 34 00 00       	call   80104210 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 3b 36 00 00       	call   801043f0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 24 36 00 00       	call   801043f0 <release>
}
...
80100e0a:	e8 e1 35 00 00       	call   801043f0 <release>
  return f;
}
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 80 35 00 00       	jmp    801043f0 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 5c 35 00 00       	call   801043f0 <release>
  if(ff.type == FD_PIPE)
...
801011f8:	e8 43 32 00 00       	call   80104440 <memset>
  log_write(bp);
...
80101276:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101279:	e8 72 31 00 00       	call   801043f0 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
801012be:	e8 2d 31 00 00       	call   801043f0 <release>
}
...
801013d2:	e8 09 31 00 00       	call   801044e0 <memmove>
  brelse(bp);
...
8010149b:	e8 70 2d 00 00       	call   80104210 <initlock>
...
801014b0:	80 
801014b1:	e8 2a 2c 00 00       	call   801040e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015b9:	e8 82 2e 00 00       	call   80104440 <memset>
      dip->type = type;
...
8010166f:	00 
80101670:	e8 6b 2e 00 00       	call   801044e0 <memmove>
  log_write(bp);
...
801016b1:	e8 3a 2d 00 00       	call   801043f0 <release>
}
...
801016e4:	e8 37 2a 00 00       	call   80104120 <acquiresleep>
  if(ip->valid == 0){
...
8010175b:	e8 80 2d 00 00       	call   801044e0 <memmove>
    brelse(bp);
...
801017b5:	e8 06 2a 00 00       	call   801041c0 <holdingsleep>
...
801017cd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017ce:	e9 ad 29 00 00       	jmp    80104180 <releasesleep>
    panic("iunlock");
...
801017f2:	e8 29 29 00 00       	call   80104120 <acquiresleep>
...
80101808:	e8 73 29 00 00       	call   80104180 <releasesleep>
  acquire(&icache.lock);
8010180d:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101814:	e8 67 2b 00 00       	call   80104380 <acquire>
  ip->ref--;
...
8010182a:	5d                   	pop    %ebp
  release(&icache.lock);
8010182b:	e9 c0 2b 00 00       	jmp    801043f0 <release>
    acquire(&icache.lock);
80101830:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101837:	e8 44 2b 00 00       	call   80104380 <acquire>
    int r = ip->ref;
8010183c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010183f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101846:	e8 a5 2b 00 00       	call   801043f0 <release>
    if(r == 1){
...
80101bbb:	e8 a0 29 00 00       	call   80104560 <strncmp>
}
80101bc0:	c9                   	leave  
80101bc1:	c3                   	ret    
...
80101c39:	e8 22 29 00 00       	call   80104560 <strncmp>
      continue;
...
80101cb8:	e8 c3 26 00 00       	call   80104380 <acquire>
  ip->ref++;
80101cbd:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cc1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cc8:	e8 23 27 00 00       	call   801043f0 <release>
...
80101d2b:	e8 b0 27 00 00       	call   801044e0 <memmove>
    path++;
...
80101db9:	e8 22 27 00 00       	call   801044e0 <memmove>
    name[len] = 0;
...
80101eb3:	e8 18 27 00 00       	call   801045d0 <strncpy>
  de.inum = inum;
...
80102025:	e8 e6 21 00 00       	call   80104210 <initlock>
...
801020a0:	e8 db 22 00 00       	call   80104380 <acquire>
...
801020cc:	e8 4f 1e 00 00       	call   80103f20 <wakeup>
...
801020e6:	e8 05 23 00 00       	call   801043f0 <release>
...
80102140:	e8 7b 20 00 00       	call   801041c0 <holdingsleep>
...
80102176:	e8 05 22 00 00       	call   80104380 <acquire>
...
801021d5:	5d                   	pop    %ebp
  release(&idelock);
801021d6:	e9 15 22 00 00       	jmp    801043f0 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010233a:	e8 01 21 00 00       	call   80104440 <memset>
...
80102373:	5d                   	pop    %ebp
    release(&kmem.lock);
80102374:	e9 77 20 00 00       	jmp    801043f0 <release>
80102379:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&kmem.lock);
80102380:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
80102387:	e8 f4 1f 00 00       	call   80104380 <acquire>
...
8010240a:	e8 01 1e 00 00       	call   80104210 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024dd:	e8 0e 1f 00 00       	call   801043f0 <release>
  return (char*)r;
}
...
801024f7:	e8 84 1e 00 00       	call   80104380 <acquire>
...
801028ac:	e8 df 1b 00 00       	call   80104490 <memcmp>
...
801029d7:	e8 04 1b 00 00       	call   801044e0 <memmove>
...
80102a9a:	e8 71 17 00 00       	call   80104210 <initlock>
  readsb(dev, &sb);
...
80102b2d:	e8 4e 18 00 00       	call   80104380 <acquire>
...
80102b75:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b7a:	e8 71 18 00 00       	call   801043f0 <release>
      break;
    }
  }
}
...
80102ba0:	e8 db 17 00 00       	call   80104380 <acquire>
  log.outstanding -= 1;
...
80102bd8:	00 00 00 
  release(&log.lock);
80102bdb:	e8 10 18 00 00       	call   801043f0 <release>
  if (log.lh.n > 0) {
...
80102c3f:	e8 9c 18 00 00       	call   801044e0 <memmove>
...
80102cfd:	e8 7e 16 00 00       	call   80104380 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d4e:	5d                   	pop    %ebp
  release(&log.lock);
80102d4f:	e9 9c 16 00 00       	jmp    801043f0 <release>
...
80102e81:	e8 5a 16 00 00       	call   801044e0 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f5b:	e8 30 15 00 00       	call   80104490 <memcmp>
...
80103016:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103019:	e8 72 14 00 00       	call   80104490 <memcmp>
...
801031f6:	80 
801031f7:	e8 14 10 00 00       	call   80104210 <initlock>
  (*f0)->type = FD_PIPE;
...
80103281:	e8 fa 10 00 00       	call   80104380 <acquire>
  if(writable){
...
8010329d:	e8 7e 0c 00 00       	call   80103f20 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032be:	5d                   	pop    %ebp
    release(&p->lock);
801032bf:	e9 2c 11 00 00       	jmp    801043f0 <release>
...
80103392:	e8 59 10 00 00       	call   801043f0 <release>
        return -1;
...
801033da:	e8 41 0b 00 00       	call   80103f20 <wakeup>
  release(&p->lock);
801033df:	89 1c 24             	mov    %ebx,(%esp)
801033e2:	e8 09 10 00 00       	call   801043f0 <release>
  return n;
...
80103402:	e8 79 0f 00 00       	call   80104380 <acquire>
...
8010345b:	e8 90 0f 00 00       	call   801043f0 <release>
...
801034b5:	e8 66 0a 00 00       	call   80103f20 <wakeup>
  release(&p->lock);
801034ba:	89 34 24             	mov    %esi,(%esp)
801034bd:	e8 2e 0f 00 00       	call   801043f0 <release>
}
...
801034e3:	e8 98 0e 00 00       	call   80104380 <acquire>
...
80103521:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103524:	e8 c7 0e 00 00       	call   801043f0 <release>
...
80103540:	89 53 20             	mov    %edx,0x20(%ebx)
  *(uint*)sp = (uint)trapret;
80103543:	c7 40 14 95 56 10 80 	movl   $0x80105695,0x14(%eax)
...
8010355d:	89 43 24             	mov    %eax,0x24(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103560:	e8 db 0e 00 00       	call   80104440 <memset>
...
8010357f:	e8 6c 0e 00 00       	call   801043f0 <release>
}
...
801035ad:	e8 3e 0e 00 00       	call   801043f0 <release>
...
80103605:	e8 06 0c 00 00       	call   80104210 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
801036b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036b7:	e8 d4 0b 00 00       	call   80104290 <pushcli>
  c = mycpu();
801036bc:	e8 4f ff ff ff       	call   80103610 <mycpu>
  p = c->proc;
801036c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036c7:	e8 04 0c 00 00       	call   801042d0 <popcli>
}
...
801036f3:	e8 18 35 00 00       	call   80106c10 <setupkvm>
...
80103715:	80 
80103716:	e8 25 32 00 00       	call   80106940 <inituvm>
  p->sz = PGSIZE;
...
80103737:	e8 04 0d 00 00       	call   80104440 <memset>
...
8010379e:	e8 7d 0e 00 00       	call   80104620 <safestrcpy>
  p->cwd = namei("/");
...
80103819:	e8 62 32 00 00       	call   80106a80 <allocuvm>
...
80103827:	e8 04 30 00 00       	call   80106830 <switchuvm>
  return 0;
...
8010384a:	e8 21 33 00 00       	call   80106b70 <deallocuvm>
...
8010388e:	e8 5d 34 00 00       	call   80106cf0 <copyuvm>
...
80103974:	56                   	push   %esi
	if(time % 100 == 0) {
80103975:	be 1f 85 eb 51       	mov    $0x51eb851f,%esi
{
8010397a:	53                   	push   %ebx
8010397b:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
8010397e:	e8 8d fc ff ff       	call   80103610 <mycpu>
	if(time % 100 == 0) {
80103983:	8b 0d a0 56 11 80    	mov    0x801156a0,%ecx
  struct cpu *c = mycpu();
80103989:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
8010398b:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103992:	00 00 00 
	if(time % 100 == 0) {
80103995:	89 c8                	mov    %ecx,%eax
80103997:	f7 e6                	mul    %esi
80103999:	8d 43 04             	lea    0x4(%ebx),%eax
8010399c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010399f:	89 d6                	mov    %edx,%esi
801039a1:	c1 ee 05             	shr    $0x5,%esi
801039a4:	6b f6 64             	imul   $0x64,%esi,%esi
801039a7:	29 f1                	sub    %esi,%ecx
801039a9:	89 ce                	mov    %ecx,%esi
  asm volatile("sti");
801039ab:	fb                   	sti    
    acquire(&ptable.lock);
801039ac:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039b3:	e8 c8 09 00 00       	call   80104380 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039b8:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801039bd:	8d 76 00             	lea    0x0(%esi),%esi
      for(q = p; q < &ptable.proc[NPROC]; q++) {	
801039c0:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039c5:	89 c7                	mov    %eax,%edi
801039c7:	72 13                	jb     801039dc <scheduler+0x6c>
801039c9:	eb 2c                	jmp    801039f7 <scheduler+0x87>
801039cb:	90                   	nop
801039cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801039d0:	05 84 00 00 00       	add    $0x84,%eax
801039d5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039da:	73 1b                	jae    801039f7 <scheduler+0x87>
	if(q->state != RUNNABLE)
801039dc:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
801039e0:	75 ee                	jne    801039d0 <scheduler+0x60>
801039e2:	8b 50 18             	mov    0x18(%eax),%edx
801039e5:	39 57 18             	cmp    %edx,0x18(%edi)
801039e8:	0f 4f f8             	cmovg  %eax,%edi
      for(q = p; q < &ptable.proc[NPROC]; q++) {	
801039eb:	05 84 00 00 00       	add    $0x84,%eax
801039f0:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039f5:	72 e5                	jb     801039dc <scheduler+0x6c>
        if(p->state != RUNNABLE)
801039f7:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
801039fb:	74 1b                	je     80103a18 <scheduler+0xa8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039fd:	8d 87 84 00 00 00    	lea    0x84(%edi),%eax
80103a03:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103a08:	72 b6                	jb     801039c0 <scheduler+0x50>
    release(&ptable.lock);
80103a0a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a11:	e8 da 09 00 00       	call   801043f0 <release>
  }
80103a16:	eb 93                	jmp    801039ab <scheduler+0x3b>
	if(time % 100 == 0) {
80103a18:	85 f6                	test   %esi,%esi
80103a1a:	75 20                	jne    80103a3c <scheduler+0xcc>
80103a1c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103a21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            if(r != p){
80103a28:	39 f8                	cmp    %edi,%eax
80103a2a:	74 04                	je     80103a30 <scheduler+0xc0>
	      p->priority = p->priority - 1;
80103a2c:	83 6f 18 01          	subl   $0x1,0x18(%edi)
	  for(r = ptable.proc; r < &ptable.proc[NPROC]; r++){
80103a30:	05 84 00 00 00       	add    $0x84,%eax
80103a35:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103a3a:	75 ec                	jne    80103a28 <scheduler+0xb8>
        c->proc = p;
80103a3c:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
        switchuvm(p);
80103a42:	89 3c 24             	mov    %edi,(%esp)
80103a45:	e8 e6 2d 00 00       	call   80106830 <switchuvm>
        swtch(&(c->scheduler), p->context);
80103a4a:	8b 47 24             	mov    0x24(%edi),%eax
        p->state = RUNNING;
80103a4d:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
        swtch(&(c->scheduler), p->context);
80103a54:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a58:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103a5b:	89 04 24             	mov    %eax,(%esp)
80103a5e:	e8 18 0c 00 00       	call   8010467b <swtch>
        switchkvm();
80103a63:	e8 a8 2d 00 00       	call   80106810 <switchkvm>
        c->proc = 0;
80103a68:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a6f:	00 00 00 
80103a72:	eb 89                	jmp    801039fd <scheduler+0x8d>
80103a74:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103a7a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80103a80 <setpriority>:
...
80103ac4:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103ac6:	e8 75 08 00 00       	call   80104340 <holding>
80103acb:	85 c0                	test   %eax,%eax
80103acd:	74 4f                	je     80103b1e <sched+0x6e>
  if(mycpu()->ncli != 1)
80103acf:	e8 3c fb ff ff       	call   80103610 <mycpu>
...
80103ae8:	75 40                	jne    80103b2a <sched+0x7a>
  intena = mycpu()->intena;
80103aea:	e8 21 fb ff ff       	call   80103610 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103aef:	83 c3 24             	add    $0x24,%ebx
  intena = mycpu()->intena;
80103af2:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103af8:	e8 13 fb ff ff       	call   80103610 <mycpu>
80103afd:	8b 40 04             	mov    0x4(%eax),%eax
80103b00:	89 1c 24             	mov    %ebx,(%esp)
80103b03:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b07:	e8 6f 0b 00 00       	call   8010467b <swtch>
  mycpu()->intena = intena;
80103b0c:	e8 ff fa ff ff       	call   80103610 <mycpu>
...
80103b57:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103b5a:	e8 51 fb ff ff       	call   801036b0 <myproc>
  if(curproc == initproc)
80103b5f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103b65:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103b67:	0f 84 03 01 00 00    	je     80103c70 <exit+0x120>
80103b6d:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd]){
80103b70:	8b 44 b3 30          	mov    0x30(%ebx,%esi,4),%eax
...
80103b7b:	e8 b0 d2 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103b80:	c7 44 b3 30 00 00 00 	movl   $0x0,0x30(%ebx,%esi,4)
80103b87:	00 
...
80103bc8:	81 c2 84 00 00 00    	add    $0x84,%edx
80103bce:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103bd4:	74 20                	je     80103bf6 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103bd6:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103bda:	75 ec                	jne    80103bc8 <exit+0x78>
80103bdc:	3b 42 28             	cmp    0x28(%edx),%eax
80103bdf:	75 e7                	jne    80103bc8 <exit+0x78>
      p->state = RUNNABLE;
80103be1:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103be8:	81 c2 84 00 00 00    	add    $0x84,%edx
80103bee:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103c02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c08:	81 c1 84 00 00 00    	add    $0x84,%ecx
80103c0e:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
80103c14:	74 3c                	je     80103c52 <exit+0x102>
    if(p->parent == curproc){
80103c16:	39 59 1c             	cmp    %ebx,0x1c(%ecx)
80103c19:	75 ed                	jne    80103c08 <exit+0xb8>
      if(p->state == ZOMBIE)
80103c1b:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
80103c1f:	89 41 1c             	mov    %eax,0x1c(%ecx)
      if(p->state == ZOMBIE)
...
80103c2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c30:	81 c2 84 00 00 00    	add    $0x84,%edx
80103c36:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103c3c:	74 ca                	je     80103c08 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103c3e:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103c42:	75 ec                	jne    80103c30 <exit+0xe0>
80103c44:	3b 42 28             	cmp    0x28(%edx),%eax
...
80103c55:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->exit_status = status;
80103c5c:	89 43 14             	mov    %eax,0x14(%ebx)
  sched();
80103c5f:	e8 4c fe ff ff       	call   80103ab0 <sched>
  panic("zombie exit");
80103c64:	c7 04 24 9d 74 10 80 	movl   $0x8010749d,(%esp)
80103c6b:	e8 f0 c6 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c70:	c7 04 24 90 74 10 80 	movl   $0x80107490,(%esp)
...
80103c8d:	e8 ee 06 00 00       	call   80104380 <acquire>
  myproc()->state = RUNNABLE;
80103c92:	e8 19 fa ff ff       	call   801036b0 <myproc>
80103c97:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103c9e:	e8 0d fe ff ff       	call   80103ab0 <sched>
  release(&ptable.lock);
80103ca3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103caa:	e8 41 07 00 00       	call   801043f0 <release>
}
80103caf:	c9                   	leave  
80103cb0:	c3                   	ret    
...
80103ccc:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103ccf:	e8 dc f9 ff ff       	call   801036b0 <myproc>
  if(p == 0)
...
80103cf1:	e8 8a 06 00 00       	call   80104380 <acquire>
    release(lk);
80103cf6:	89 34 24             	mov    %esi,(%esp)
80103cf9:	e8 f2 06 00 00       	call   801043f0 <release>
  p->chan = chan;
80103cfe:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
80103d01:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103d08:	e8 a3 fd ff ff       	call   80103ab0 <sched>
  p->chan = 0;
80103d0d:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
    release(&ptable.lock);
80103d14:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d1b:	e8 d0 06 00 00       	call   801043f0 <release>
    acquire(lk);
...
80103d29:	5d                   	pop    %ebp
    acquire(lk);
80103d2a:	e9 51 06 00 00       	jmp    80104380 <acquire>
80103d2f:	90                   	nop
  p->chan = chan;
80103d30:	89 78 28             	mov    %edi,0x28(%eax)
  p->state = SLEEPING;
...
80103d4e:	c7 04 24 af 74 10 80 	movl   $0x801074af,(%esp)
80103d55:	e8 06 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103d5a:	c7 04 24 a9 74 10 80 	movl   $0x801074a9,(%esp)
...
80103d75:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc(); 
80103d78:	e8 33 f9 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103d7d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc(); 
80103d84:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d86:	e8 f5 05 00 00       	call   80104380 <acquire>
    havekids = 0;
...
80103d98:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103d9e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103da4:	74 22                	je     80103dc8 <wait+0x58>
      if(p->parent != curproc)
80103da6:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80103da9:	75 ed                	jne    80103d98 <wait+0x28>
      if(p->state == ZOMBIE){
80103dab:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103daf:	74 34                	je     80103de5 <wait+0x75>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103db1:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103db7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dbc:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103dc2:	75 e2                	jne    80103da6 <wait+0x36>
80103dc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103dc8:	85 c0                	test   %eax,%eax
80103dca:	74 76                	je     80103e42 <wait+0xd2>
80103dcc:	8b 46 2c             	mov    0x2c(%esi),%eax
80103dcf:	85 c0                	test   %eax,%eax
80103dd1:	75 6f                	jne    80103e42 <wait+0xd2>
...
80103de5:	8b 53 14             	mov    0x14(%ebx),%edx
...
80103dee:	89 10                	mov    %edx,(%eax)
        kfree(p->kstack);
80103df0:	8b 43 08             	mov    0x8(%ebx),%eax
80103df3:	89 04 24             	mov    %eax,(%esp)
80103df6:	e8 05 e5 ff ff       	call   80102300 <kfree>
        freevm(p->pgdir);
80103dfb:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103dfe:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e05:	89 04 24             	mov    %eax,(%esp)
80103e08:	e8 83 2d 00 00       	call   80106b90 <freevm>
        release(&ptable.lock);
80103e0d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103e14:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e1b:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
80103e22:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
80103e26:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
	p->state = UNUSED;
80103e2d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e34:	e8 b7 05 00 00       	call   801043f0 <release>
}
80103e39:	83 c4 10             	add    $0x10,%esp
        return pid;
80103e3c:	89 f0                	mov    %esi,%eax
}
80103e3e:	5b                   	pop    %ebx
80103e3f:	5e                   	pop    %esi
80103e40:	5d                   	pop    %ebp
...
80103e49:	e8 a2 05 00 00       	call   801043f0 <release>
}
...
80103e68:	8b 75 08             	mov    0x8(%ebp),%esi
  acquire(&ptable.lock);
80103e6b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e72:	e8 09 05 00 00       	call   80104380 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103e77:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103e7c:	eb 10                	jmp    80103e8e <waitpid+0x2e>
80103e7e:	66 90                	xchg   %ax,%ax
80103e80:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103e86:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103e8c:	74 6a                	je     80103ef8 <waitpid+0x98>
      if(p->pid != pid)
80103e8e:	39 73 10             	cmp    %esi,0x10(%ebx)
80103e91:	75 ed                	jne    80103e80 <waitpid+0x20>
      if(p->state == ZOMBIE){
80103e93:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103e97:	75 e7                	jne    80103e80 <waitpid+0x20>
	*status = p->exit_status;
80103e99:	8b 53 14             	mov    0x14(%ebx),%edx
80103e9c:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e9f:	89 10                	mov    %edx,(%eax)
        kfree(p->kstack);
80103ea1:	8b 43 08             	mov    0x8(%ebx),%eax
80103ea4:	89 04 24             	mov    %eax,(%esp)
80103ea7:	e8 54 e4 ff ff       	call   80102300 <kfree>
        freevm(p->pgdir);
80103eac:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103eaf:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103eb6:	89 04 24             	mov    %eax,(%esp)
80103eb9:	e8 d2 2c 00 00       	call   80106b90 <freevm>
        release(&ptable.lock);
80103ebe:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103ec5:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103ecc:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
80103ed3:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
80103ed7:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
        p->state = UNUSED;
80103ede:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103ee5:	e8 06 05 00 00       	call   801043f0 <release>
}
...
80103ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(p, &ptable.lock);
80103ef8:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103eff:	80 
80103f00:	c7 04 24 54 4e 11 80 	movl   $0x80114e54,(%esp)
80103f07:	e8 b4 fd ff ff       	call   80103cc0 <sleep>
  }
80103f0c:	e9 66 ff ff ff       	jmp    80103e77 <waitpid+0x17>
80103f11:	eb 0d                	jmp    80103f20 <wakeup>
80103f13:	90                   	nop
80103f14:	90                   	nop
80103f15:	90                   	nop
80103f16:	90                   	nop
...
80103f52:	3b 58 28             	cmp    0x28(%eax),%ebx
...
80103f63:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103f7b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103f7c:	e9 6f 04 00 00       	jmp    801043f0 <release>
...
80103fa1:	e8 da 03 00 00       	call   80104380 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa6:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103fab:	eb 0f                	jmp    80103fbc <kill+0x2c>
80103fad:	8d 76 00             	lea    0x0(%esi),%esi
80103fb0:	05 84 00 00 00       	add    $0x84,%eax
80103fb5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103fc1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80103fc5:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
      if(p->state == SLEEPING)
80103fcc:	74 1a                	je     80103fe8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103fce:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103fd5:	e8 16 04 00 00       	call   801043f0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103fff:	e8 ec 03 00 00       	call   801043f0 <release>
}
...
80104016:	bb c8 2d 11 80       	mov    $0x80112dc8,%ebx
...
8010409f:	e8 8c 01 00 00       	call   80104230 <getcallerpcs>
...
801040b9:	c7 04 24 01 6f 10 80 	movl   $0x80106f01,(%esp)
...
801040ea:	c7 44 24 04 38 75 10 	movl   $0x80107538,0x4(%esp)
801040f1:	80 
801040f2:	8d 43 04             	lea    0x4(%ebx),%eax
801040f5:	89 04 24             	mov    %eax,(%esp)
801040f8:	e8 13 01 00 00       	call   80104210 <initlock>
  lk->name = name;
801040fd:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
80104100:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80104106:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010410d:	89 43 38             	mov    %eax,0x38(%ebx)
}
80104110:	83 c4 14             	add    $0x14,%esp
80104113:	5b                   	pop    %ebx
80104114:	5d                   	pop    %ebp
80104115:	c3                   	ret    
...
80104131:	e8 4a 02 00 00       	call   80104380 <acquire>
  while (lk->locked) {
80104136:	8b 13                	mov    (%ebx),%edx
80104138:	85 d2                	test   %edx,%edx
8010413a:	74 16                	je     80104152 <acquiresleep+0x32>
8010413c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104140:	89 74 24 04          	mov    %esi,0x4(%esp)
80104144:	89 1c 24             	mov    %ebx,(%esp)
80104147:	e8 74 fb ff ff       	call   80103cc0 <sleep>
  while (lk->locked) {
8010414c:	8b 03                	mov    (%ebx),%eax
8010414e:	85 c0                	test   %eax,%eax
80104150:	75 ee                	jne    80104140 <acquiresleep+0x20>
  }
  lk->locked = 1;
80104152:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104158:	e8 53 f5 ff ff       	call   801036b0 <myproc>
8010415d:	8b 40 10             	mov    0x10(%eax),%eax
80104160:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
...
8010416b:	5d                   	pop    %ebp
  release(&lk->lk);
8010416c:	e9 7f 02 00 00       	jmp    801043f0 <release>
80104171:	eb 0d                	jmp    80104180 <releasesleep>
80104173:	90                   	nop
80104174:	90                   	nop
80104175:	90                   	nop
80104176:	90                   	nop
...
80104191:	e8 ea 01 00 00       	call   80104380 <acquire>
  lk->locked = 0;
80104196:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010419c:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801041a3:	89 1c 24             	mov    %ebx,(%esp)
801041a6:	e8 75 fd ff ff       	call   80103f20 <wakeup>
  release(&lk->lk);
801041ab:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801041b3:	5d                   	pop    %ebp
  release(&lk->lk);
801041b4:	e9 37 02 00 00       	jmp    801043f0 <release>
...
801041c4:	31 ff                	xor    %edi,%edi
{
801041c6:	56                   	push   %esi
801041c7:	53                   	push   %ebx
801041c8:	83 ec 1c             	sub    $0x1c,%esp
801041cb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801041ce:	8d 73 04             	lea    0x4(%ebx),%esi
801041d1:	89 34 24             	mov    %esi,(%esp)
801041d4:	e8 a7 01 00 00       	call   80104380 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801041d9:	8b 03                	mov    (%ebx),%eax
801041db:	85 c0                	test   %eax,%eax
801041dd:	74 13                	je     801041f2 <holdingsleep+0x32>
801041df:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801041e2:	e8 c9 f4 ff ff       	call   801036b0 <myproc>
801041e7:	3b 58 10             	cmp    0x10(%eax),%ebx
801041ea:	0f 94 c0             	sete   %al
801041ed:	0f b6 c0             	movzbl %al,%eax
801041f0:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
801041f2:	89 34 24             	mov    %esi,(%esp)
801041f5:	e8 f6 01 00 00       	call   801043f0 <release>
  return r;
}
801041fa:	83 c4 1c             	add    $0x1c,%esp
801041fd:	89 f8                	mov    %edi,%eax
801041ff:	5b                   	pop    %ebx
80104200:	5e                   	pop    %esi
80104201:	5f                   	pop    %edi
80104202:	5d                   	pop    %ebp
...
{
80104236:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
801042a9:	e8 62 f3 ff ff       	call   80103610 <mycpu>
801042ae:	81 e3 00 02 00 00    	and    $0x200,%ebx
801042b4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801042ba:	e8 51 f3 ff ff       	call   80103610 <mycpu>
...
801042db:	75 49                	jne    80104326 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801042dd:	e8 2e f3 ff ff       	call   80103610 <mycpu>
...
801042f5:	e8 16 f3 ff ff       	call   80103610 <mycpu>
...
80104306:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104308:	e8 03 f3 ff ff       	call   80103610 <mycpu>
...
80104319:	c3                   	ret    
    panic("popcli");
8010431a:	c7 04 24 5a 75 10 80 	movl   $0x8010755a,(%esp)
80104321:	e8 3a c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104326:	c7 04 24 43 75 10 80 	movl   $0x80107543,(%esp)
...
8010434a:	e8 41 ff ff ff       	call   80104290 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010434f:	8b 03                	mov    (%ebx),%eax
80104351:	85 c0                	test   %eax,%eax
80104353:	74 12                	je     80104367 <holding+0x27>
80104355:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104358:	e8 b3 f2 ff ff       	call   80103610 <mycpu>
8010435d:	39 c3                	cmp    %eax,%ebx
8010435f:	0f 94 c0             	sete   %al
80104362:	0f b6 c0             	movzbl %al,%eax
80104365:	89 c6                	mov    %eax,%esi
  popcli();
80104367:	e8 64 ff ff ff       	call   801042d0 <popcli>
}
8010436c:	89 f0                	mov    %esi,%eax
8010436e:	5b                   	pop    %ebx
8010436f:	5e                   	pop    %esi
80104370:	5d                   	pop    %ebp
80104371:	c3                   	ret    
...
80104387:	e8 04 ff ff ff       	call   80104290 <pushcli>
  if(holding(lk))
8010438c:	8b 45 08             	mov    0x8(%ebp),%eax
8010438f:	89 04 24             	mov    %eax,(%esp)
80104392:	e8 a9 ff ff ff       	call   80104340 <holding>
80104397:	85 c0                	test   %eax,%eax
80104399:	75 3a                	jne    801043d5 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010439b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
801043a0:	8b 55 08             	mov    0x8(%ebp),%edx
801043a3:	89 c8                	mov    %ecx,%eax
801043a5:	f0 87 02             	lock xchg %eax,(%edx)
801043a8:	85 c0                	test   %eax,%eax
801043aa:	75 f4                	jne    801043a0 <acquire+0x20>
  __sync_synchronize();
801043ac:	0f ae f0             	mfence 
  lk->cpu = mycpu();
801043af:	8b 5d 08             	mov    0x8(%ebp),%ebx
801043b2:	e8 59 f2 ff ff       	call   80103610 <mycpu>
801043b7:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801043ba:	8b 45 08             	mov    0x8(%ebp),%eax
801043bd:	83 c0 0c             	add    $0xc,%eax
801043c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801043c4:	8d 45 08             	lea    0x8(%ebp),%eax
801043c7:	89 04 24             	mov    %eax,(%esp)
801043ca:	e8 61 fe ff ff       	call   80104230 <getcallerpcs>
}
801043cf:	83 c4 14             	add    $0x14,%esp
801043d2:	5b                   	pop    %ebx
801043d3:	5d                   	pop    %ebp
801043d4:	c3                   	ret    
    panic("acquire");
801043d5:	c7 04 24 61 75 10 80 	movl   $0x80107561,(%esp)
801043dc:	e8 7f bf ff ff       	call   80100360 <panic>
801043e1:	eb 0d                	jmp    801043f0 <release>
801043e3:	90                   	nop
801043e4:	90                   	nop
801043e5:	90                   	nop
801043e6:	90                   	nop
...
801043fd:	e8 3e ff ff ff       	call   80104340 <holding>
80104402:	85 c0                	test   %eax,%eax
80104404:	74 21                	je     80104427 <release+0x37>
  lk->pcs[0] = 0;
80104406:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
8010440d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104414:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104417:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010441d:	83 c4 14             	add    $0x14,%esp
80104420:	5b                   	pop    %ebx
80104421:	5d                   	pop    %ebp
  popcli();
80104422:	e9 a9 fe ff ff       	jmp    801042d0 <popcli>
    panic("release");
80104427:	c7 04 24 69 75 10 80 	movl   $0x80107569,(%esp)
8010442e:	e8 2d bf ff ff       	call   80100360 <panic>
80104433:	66 90                	xchg   %ax,%ax
...
801044a1:	8d 78 ff             	lea    -0x1(%eax),%edi
801044a4:	74 26                	je     801044cc <memcmp+0x3c>
    if(*s1 != *s2)
801044a6:	0f b6 03             	movzbl (%ebx),%eax
801044a9:	31 d2                	xor    %edx,%edx
801044ab:	0f b6 0e             	movzbl (%esi),%ecx
801044ae:	38 c8                	cmp    %cl,%al
801044b0:	74 16                	je     801044c8 <memcmp+0x38>
801044b2:	eb 24                	jmp    801044d8 <memcmp+0x48>
801044b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801044b8:	0f b6 44 13 01       	movzbl 0x1(%ebx,%edx,1),%eax
801044bd:	83 c2 01             	add    $0x1,%edx
801044c0:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
801044c4:	38 c8                	cmp    %cl,%al
801044c6:	75 10                	jne    801044d8 <memcmp+0x48>
  while(n-- > 0){
801044c8:	39 fa                	cmp    %edi,%edx
...
801044ec:	8b 5d 10             	mov    0x10(%ebp),%ebx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801044ef:	39 c6                	cmp    %eax,%esi
801044f1:	73 35                	jae    80104528 <memmove+0x48>
801044f3:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
801044f6:	39 c8                	cmp    %ecx,%eax
801044f8:	73 2e                	jae    80104528 <memmove+0x48>
    s += n;
    d += n;
    while(n-- > 0)
801044fa:	85 db                	test   %ebx,%ebx
    d += n;
801044fc:	8d 3c 18             	lea    (%eax,%ebx,1),%edi
    while(n-- > 0)
801044ff:	8d 53 ff             	lea    -0x1(%ebx),%edx
80104502:	74 1b                	je     8010451f <memmove+0x3f>
80104504:	f7 db                	neg    %ebx
80104506:	8d 34 19             	lea    (%ecx,%ebx,1),%esi
80104509:	01 fb                	add    %edi,%ebx
8010450b:	90                   	nop
8010450c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104510:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104514:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
    while(n-- > 0)
80104517:	83 ea 01             	sub    $0x1,%edx
8010451a:	83 fa ff             	cmp    $0xffffffff,%edx
8010451d:	75 f1                	jne    80104510 <memmove+0x30>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
8010452c:	74 f1                	je     8010451f <memmove+0x3f>
...
80104564:	8b 75 10             	mov    0x10(%ebp),%esi
80104567:	53                   	push   %ebx
80104568:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010456b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
8010456e:	85 f6                	test   %esi,%esi
80104570:	74 30                	je     801045a2 <strncmp+0x42>
80104572:	0f b6 01             	movzbl (%ecx),%eax
80104575:	84 c0                	test   %al,%al
80104577:	74 2f                	je     801045a8 <strncmp+0x48>
80104579:	0f b6 13             	movzbl (%ebx),%edx
8010457c:	38 d0                	cmp    %dl,%al
8010457e:	75 46                	jne    801045c6 <strncmp+0x66>
80104580:	8d 51 01             	lea    0x1(%ecx),%edx
80104583:	01 ce                	add    %ecx,%esi
80104585:	eb 14                	jmp    8010459b <strncmp+0x3b>
80104587:	90                   	nop
80104588:	0f b6 02             	movzbl (%edx),%eax
8010458b:	84 c0                	test   %al,%al
8010458d:	74 31                	je     801045c0 <strncmp+0x60>
8010458f:	0f b6 19             	movzbl (%ecx),%ebx
80104592:	83 c2 01             	add    $0x1,%edx
80104595:	38 d8                	cmp    %bl,%al
80104597:	75 17                	jne    801045b0 <strncmp+0x50>
    n--, p++, q++;
80104599:	89 cb                	mov    %ecx,%ebx
  while(n > 0 && *p && *p == *q)
8010459b:	39 f2                	cmp    %esi,%edx
    n--, p++, q++;
8010459d:	8d 4b 01             	lea    0x1(%ebx),%ecx
  while(n > 0 && *p && *p == *q)
...
801045a6:	5d                   	pop    %ebp
801045a7:	c3                   	ret    
801045a8:	0f b6 1b             	movzbl (%ebx),%ebx
  while(n > 0 && *p && *p == *q)
801045ab:	31 c0                	xor    %eax,%eax
801045ad:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
801045b0:	0f b6 d3             	movzbl %bl,%edx
801045b3:	29 d0                	sub    %edx,%eax
}
801045b5:	5b                   	pop    %ebx
801045b6:	5e                   	pop    %esi
801045b7:	5d                   	pop    %ebp
...
801045c0:	0f b6 5b 01          	movzbl 0x1(%ebx),%ebx
801045c4:	eb ea                	jmp    801045b0 <strncmp+0x50>
  while(n > 0 && *p && *p == *q)
801045c6:	89 d3                	mov    %edx,%ebx
801045c8:	eb e6                	jmp    801045b0 <strncmp+0x50>
...
80104606:	7e 0f                	jle    80104617 <strncpy+0x47>
    *s++ = 0;
80104608:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
8010460c:	89 f3                	mov    %esi,%ebx
8010460e:	83 c1 01             	add    $0x1,%ecx
80104611:	29 cb                	sub    %ecx,%ebx
  while(n-- > 0)
80104613:	85 db                	test   %ebx,%ebx
80104615:	7f f1                	jg     80104608 <strncpy+0x38>
  return os;
}
80104617:	5b                   	pop    %ebx
80104618:	5e                   	pop    %esi
...
80104623:	8b 4d 10             	mov    0x10(%ebp),%ecx
...
80104697:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010469a:	e8 11 f0 ff ff       	call   801036b0 <myproc>
...
801046d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801046da:	e8 d1 ef ff ff       	call   801036b0 <myproc>

  if(addr >= curproc->sz)
801046df:	39 18                	cmp    %ebx,(%eax)
801046e1:	76 26                	jbe    80104709 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
801046ee:	73 19                	jae    80104709 <fetchstr+0x39>
    if(*s == 0)
801046f0:	80 3b 00             	cmpb   $0x0,(%ebx)
801046f3:	75 0d                	jne    80104702 <fetchstr+0x32>
801046f5:	eb 21                	jmp    80104718 <fetchstr+0x48>
801046f7:	90                   	nop
801046f8:	80 3a 00             	cmpb   $0x0,(%edx)
801046fb:	90                   	nop
801046fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104700:	74 16                	je     80104718 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80104702:	83 c2 01             	add    $0x1,%edx
80104705:	39 d0                	cmp    %edx,%eax
80104707:	77 ef                	ja     801046f8 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
...
80104718:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
8010471b:	89 d0                	mov    %edx,%eax
8010471d:	29 d8                	sub    %ebx,%eax
}
8010471f:	5b                   	pop    %ebx
80104720:	5d                   	pop    %ebp
80104721:	c3                   	ret    
...
80104734:	8b 75 0c             	mov    0xc(%ebp),%esi
80104737:	53                   	push   %ebx
80104738:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010473b:	e8 70 ef ff ff       	call   801036b0 <myproc>
80104740:	89 75 0c             	mov    %esi,0xc(%ebp)
80104743:	8b 40 20             	mov    0x20(%eax),%eax
80104746:	8b 40 44             	mov    0x44(%eax),%eax
80104749:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
8010474d:	89 45 08             	mov    %eax,0x8(%ebp)
}
80104750:	5b                   	pop    %ebx
80104751:	5e                   	pop    %esi
80104752:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104753:	e9 38 ff ff ff       	jmp    80104690 <fetchint>
80104758:	90                   	nop
...
80104765:	83 ec 20             	sub    $0x20,%esp
80104768:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010476b:	e8 40 ef ff ff       	call   801036b0 <myproc>
...
8010477f:	e8 ac ff ff ff       	call   80104730 <argint>
80104784:	85 c0                	test   %eax,%eax
80104786:	78 28                	js     801047b0 <argptr+0x50>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104788:	85 db                	test   %ebx,%ebx
8010478a:	78 24                	js     801047b0 <argptr+0x50>
8010478c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010478f:	8b 06                	mov    (%esi),%eax
80104791:	39 c2                	cmp    %eax,%edx
80104793:	73 1b                	jae    801047b0 <argptr+0x50>
80104795:	01 d3                	add    %edx,%ebx
80104797:	39 d8                	cmp    %ebx,%eax
80104799:	72 15                	jb     801047b0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
801047a0:	83 c4 20             	add    $0x20,%esp
  return 0;
...
801047da:	78 14                	js     801047f0 <argstr+0x30>
    return -1;
...
801047e9:	e8 e2 fe ff ff       	call   801046d0 <fetchstr>
}
801047ee:	c9                   	leave  
801047ef:	c3                   	ret    
    return -1;
...
80104805:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104808:	e8 a3 ee ff ff       	call   801036b0 <myproc>

  num = curproc->tf->eax;
8010480d:	8b 70 20             	mov    0x20(%eax),%esi
  struct proc *curproc = myproc();
80104810:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
80104812:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104815:	8d 50 ff             	lea    -0x1(%eax),%edx
80104818:	83 fa 16             	cmp    $0x16,%edx
8010481b:	77 1b                	ja     80104838 <syscall+0x38>
8010481d:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
80104824:	85 d2                	test   %edx,%edx
80104826:	74 10                	je     80104838 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104828:	ff d2                	call   *%edx
8010482a:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104834:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("%d %s: unknown sys call %d\n",
80104838:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010483c:	8d 43 74             	lea    0x74(%ebx),%eax
8010483f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80104843:	8b 43 10             	mov    0x10(%ebx),%eax
80104846:	c7 04 24 71 75 10 80 	movl   $0x80107571,(%esp)
8010484d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104851:	e8 fa bd ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80104856:	8b 43 20             	mov    0x20(%ebx),%eax
80104859:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104874:	89 c3                	mov    %eax,%ebx
80104876:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104879:	e8 32 ee ff ff       	call   801036b0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
8010487e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104880:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
80104884:	85 c9                	test   %ecx,%ecx
80104886:	74 18                	je     801048a0 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80104888:	83 c2 01             	add    $0x1,%edx
8010488b:	83 fa 10             	cmp    $0x10,%edx
8010488e:	75 f0                	jne    80104880 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
8010489c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
801048a0:	89 5c 90 30          	mov    %ebx,0x30(%eax,%edx,4)
}
801048a4:	83 c4 04             	add    $0x4,%esp
      return fd;
...
801048b6:	83 ec 4c             	sub    $0x4c,%esp
801048b9:	89 4d c0             	mov    %ecx,-0x40(%ebp)
801048bc:	8b 4d 08             	mov    0x8(%ebp),%ecx
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801048bf:	8d 5d da             	lea    -0x26(%ebp),%ebx
801048c2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801048c6:	89 04 24             	mov    %eax,(%esp)
{
801048c9:	89 55 c4             	mov    %edx,-0x3c(%ebp)
801048cc:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801048cf:	e8 5c d6 ff ff       	call   80101f30 <nameiparent>
801048d4:	85 c0                	test   %eax,%eax
801048d6:	89 c7                	mov    %eax,%edi
801048d8:	0f 84 da 00 00 00    	je     801049b8 <create+0x108>
    return 0;
  ilock(dp);
801048de:	89 04 24             	mov    %eax,(%esp)
801048e1:	e8 da cd ff ff       	call   801016c0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801048e6:	8d 45 d4             	lea    -0x2c(%ebp),%eax
801048e9:	89 44 24 08          	mov    %eax,0x8(%esp)
801048ed:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801048f1:	89 3c 24             	mov    %edi,(%esp)
801048f4:	e8 d7 d2 ff ff       	call   80101bd0 <dirlookup>
801048f9:	85 c0                	test   %eax,%eax
801048fb:	89 c6                	mov    %eax,%esi
801048fd:	74 41                	je     80104940 <create+0x90>
    iunlockput(dp);
801048ff:	89 3c 24             	mov    %edi,(%esp)
80104902:	e8 19 d0 ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104907:	89 34 24             	mov    %esi,(%esp)
8010490a:	e8 b1 cd ff ff       	call   801016c0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010490f:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104914:	75 12                	jne    80104928 <create+0x78>
80104916:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010491b:	89 f0                	mov    %esi,%eax
8010491d:	75 09                	jne    80104928 <create+0x78>
...
8010491f:	83 c4 4c             	add    $0x4c,%esp
80104922:	5b                   	pop    %ebx
80104923:	5e                   	pop    %esi
80104924:	5f                   	pop    %edi
80104925:	5d                   	pop    %ebp
...
8010492b:	e8 f0 cf ff ff       	call   80101920 <iunlockput>
}
...
80104948:	8b 07                	mov    (%edi),%eax
8010494a:	89 04 24             	mov    %eax,(%esp)
8010494d:	e8 de cb ff ff       	call   80101530 <ialloc>
80104952:	85 c0                	test   %eax,%eax
80104954:	89 c6                	mov    %eax,%esi
80104956:	0f 84 bf 00 00 00    	je     80104a1b <create+0x16b>
  ilock(ip);
8010495c:	89 04 24             	mov    %eax,(%esp)
8010495f:	e8 5c cd ff ff       	call   801016c0 <ilock>
  ip->major = major;
80104964:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104968:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
8010496c:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104970:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104974:	b8 01 00 00 00       	mov    $0x1,%eax
80104979:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
8010497d:	89 34 24             	mov    %esi,(%esp)
80104980:	e8 7b cc ff ff       	call   80101600 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104985:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
8010498a:	74 34                	je     801049c0 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
8010498c:	8b 46 04             	mov    0x4(%esi),%eax
8010498f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
801049a1:	78 6c                	js     80104a0f <create+0x15f>
  iunlockput(dp);
801049a3:	89 3c 24             	mov    %edi,(%esp)
801049a6:	e8 75 cf ff ff       	call   80101920 <iunlockput>
}
801049ab:	83 c4 4c             	add    $0x4c,%esp
  return ip;
801049ae:	89 f0                	mov    %esi,%eax
}
801049b0:	5b                   	pop    %ebx
801049b1:	5e                   	pop    %esi
801049b2:	5f                   	pop    %edi
...
801049ba:	e9 60 ff ff ff       	jmp    8010491f <create+0x6f>
801049bf:	90                   	nop
    dp->nlink++;  // for ".."
801049c0:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
801049c5:	89 3c 24             	mov    %edi,(%esp)
801049c8:	e8 33 cc ff ff       	call   80101600 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049cd:	8b 46 04             	mov    0x4(%esi),%eax
801049d0:	c7 44 24 04 1c 76 10 	movl   $0x8010761c,0x4(%esp)
801049d7:	80 
801049d8:	89 34 24             	mov    %esi,(%esp)
801049db:	89 44 24 08          	mov    %eax,0x8(%esp)
801049df:	e8 4c d4 ff ff       	call   80101e30 <dirlink>
801049e4:	85 c0                	test   %eax,%eax
801049e6:	78 1b                	js     80104a03 <create+0x153>
801049e8:	8b 47 04             	mov    0x4(%edi),%eax
801049eb:	c7 44 24 04 1b 76 10 	movl   $0x8010761b,0x4(%esp)
801049f2:	80 
801049f3:	89 34 24             	mov    %esi,(%esp)
801049f6:	89 44 24 08          	mov    %eax,0x8(%esp)
801049fa:	e8 31 d4 ff ff       	call   80101e30 <dirlink>
801049ff:	85 c0                	test   %eax,%eax
80104a01:	79 89                	jns    8010498c <create+0xdc>
      panic("create dots");
80104a03:	c7 04 24 0f 76 10 80 	movl   $0x8010760f,(%esp)
80104a0a:	e8 51 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104a0f:	c7 04 24 1e 76 10 80 	movl   $0x8010761e,(%esp)
80104a16:	e8 45 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a1b:	c7 04 24 00 76 10 80 	movl   $0x80107600,(%esp)
80104a22:	e8 39 b9 ff ff       	call   80100360 <panic>
...
80104a37:	89 d3                	mov    %edx,%ebx
80104a39:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104a3c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a3f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a43:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104a4a:	e8 e1 fc ff ff       	call   80104730 <argint>
80104a4f:	85 c0                	test   %eax,%eax
80104a51:	78 2d                	js     80104a80 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104a53:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104a57:	77 27                	ja     80104a80 <argfd.constprop.0+0x50>
80104a59:	e8 52 ec ff ff       	call   801036b0 <myproc>
80104a5e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a61:	8b 44 90 30          	mov    0x30(%eax,%edx,4),%eax
80104a65:	85 c0                	test   %eax,%eax
80104a67:	74 17                	je     80104a80 <argfd.constprop.0+0x50>
  if(pfd)
80104a69:	85 f6                	test   %esi,%esi
80104a6b:	74 02                	je     80104a6f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104a6d:	89 16                	mov    %edx,(%esi)
  if(pf)
80104a6f:	85 db                	test   %ebx,%ebx
80104a71:	74 1d                	je     80104a90 <argfd.constprop.0+0x60>
    *pf = f;
80104a73:	89 03                	mov    %eax,(%ebx)
  return 0;
80104a75:	31 c0                	xor    %eax,%eax
}
80104a77:	83 c4 20             	add    $0x20,%esp
80104a7a:	5b                   	pop    %ebx
80104a7b:	5e                   	pop    %esi
80104a7c:	5d                   	pop    %ebp
80104a7d:	c3                   	ret    
80104a7e:	66 90                	xchg   %ax,%ax
80104a80:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80104a92:	eb e3                	jmp    80104a77 <argfd.constprop.0+0x47>
...
80104aac:	e8 7f ff ff ff       	call   80104a30 <argfd.constprop.0>
80104ab1:	85 c0                	test   %eax,%eax
80104ab3:	78 23                	js     80104ad8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104ab5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ab8:	e8 b3 fd ff ff       	call   80104870 <fdalloc>
80104abd:	85 c0                	test   %eax,%eax
80104abf:	89 c3                	mov    %eax,%ebx
80104ac1:	78 15                	js     80104ad8 <sys_dup+0x38>
  filedup(f);
80104ac3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ac6:	89 04 24             	mov    %eax,(%esp)
80104ac9:	e8 12 c3 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104add:	eb f1                	jmp    80104ad0 <sys_dup+0x30>
80104adf:	90                   	nop
...
80104aeb:	e8 40 ff ff ff       	call   80104a30 <argfd.constprop.0>
80104af0:	85 c0                	test   %eax,%eax
80104af2:	78 54                	js     80104b48 <sys_read+0x68>
80104af4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104af7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104afb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104b02:	e8 29 fc ff ff       	call   80104730 <argint>
80104b07:	85 c0                	test   %eax,%eax
80104b09:	78 3d                	js     80104b48 <sys_read+0x68>
...
80104b20:	e8 3b fc ff ff       	call   80104760 <argptr>
80104b25:	85 c0                	test   %eax,%eax
80104b27:	78 1f                	js     80104b48 <sys_read+0x68>
...
80104b5b:	e8 d0 fe ff ff       	call   80104a30 <argfd.constprop.0>
80104b60:	85 c0                	test   %eax,%eax
80104b62:	78 54                	js     80104bb8 <sys_write+0x68>
80104b64:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b67:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b6b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104b72:	e8 b9 fb ff ff       	call   80104730 <argint>
80104b77:	85 c0                	test   %eax,%eax
80104b79:	78 3d                	js     80104bb8 <sys_write+0x68>
...
80104b90:	e8 cb fb ff ff       	call   80104760 <argptr>
80104b95:	85 c0                	test   %eax,%eax
80104b97:	78 1f                	js     80104bb8 <sys_write+0x68>
...
80104bad:	e8 2e c4 ff ff       	call   80100fe0 <filewrite>
}
80104bb2:	c9                   	leave  
80104bb3:	c3                   	ret    
...
80104bcc:	e8 5f fe ff ff       	call   80104a30 <argfd.constprop.0>
80104bd1:	85 c0                	test   %eax,%eax
80104bd3:	78 23                	js     80104bf8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104bd5:	e8 d6 ea ff ff       	call   801036b0 <myproc>
80104bda:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104bdd:	c7 44 90 30 00 00 00 	movl   $0x0,0x30(%eax,%edx,4)
80104be4:	00 
  fileclose(f);
...
80104c0b:	e8 20 fe ff ff       	call   80104a30 <argfd.constprop.0>
80104c10:	85 c0                	test   %eax,%eax
80104c12:	78 34                	js     80104c48 <sys_fstat+0x48>
80104c14:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104c17:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104c1e:	00 
80104c1f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c23:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104c2a:	e8 31 fb ff ff       	call   80104760 <argptr>
80104c2f:	85 c0                	test   %eax,%eax
80104c31:	78 15                	js     80104c48 <sys_fstat+0x48>
...
80104c40:	e8 ab c2 ff ff       	call   80100ef0 <filestat>
}
80104c45:	c9                   	leave  
80104c46:	c3                   	ret    
80104c47:	90                   	nop
...
80104c56:	83 ec 3c             	sub    $0x3c,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104c59:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104c5c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c60:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104c67:	e8 54 fb ff ff       	call   801047c0 <argstr>
80104c6c:	85 c0                	test   %eax,%eax
80104c6e:	0f 88 e6 00 00 00    	js     80104d5a <sys_link+0x10a>
80104c74:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104c77:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104c82:	e8 39 fb ff ff       	call   801047c0 <argstr>
80104c87:	85 c0                	test   %eax,%eax
80104c89:	0f 88 cb 00 00 00    	js     80104d5a <sys_link+0x10a>
  begin_op();
80104c8f:	e8 8c de ff ff       	call   80102b20 <begin_op>
  if((ip = namei(old)) == 0){
80104c94:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104c97:	89 04 24             	mov    %eax,(%esp)
80104c9a:	e8 71 d2 ff ff       	call   80101f10 <namei>
80104c9f:	85 c0                	test   %eax,%eax
80104ca1:	89 c3                	mov    %eax,%ebx
80104ca3:	0f 84 ac 00 00 00    	je     80104d55 <sys_link+0x105>
  ilock(ip);
80104ca9:	89 04 24             	mov    %eax,(%esp)
80104cac:	e8 0f ca ff ff       	call   801016c0 <ilock>
  if(ip->type == T_DIR){
80104cb1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104cb6:	0f 84 91 00 00 00    	je     80104d4d <sys_link+0xfd>
  ip->nlink++;
80104cbc:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104cc1:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104cc4:	89 1c 24             	mov    %ebx,(%esp)
80104cc7:	e8 34 c9 ff ff       	call   80101600 <iupdate>
  iunlock(ip);
80104ccc:	89 1c 24             	mov    %ebx,(%esp)
80104ccf:	e8 cc ca ff ff       	call   801017a0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104cd4:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104cd7:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104cdb:	89 04 24             	mov    %eax,(%esp)
80104cde:	e8 4d d2 ff ff       	call   80101f30 <nameiparent>
80104ce3:	85 c0                	test   %eax,%eax
80104ce5:	89 c6                	mov    %eax,%esi
80104ce7:	74 4f                	je     80104d38 <sys_link+0xe8>
  ilock(dp);
80104ce9:	89 04 24             	mov    %eax,(%esp)
80104cec:	e8 cf c9 ff ff       	call   801016c0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104cf1:	8b 03                	mov    (%ebx),%eax
80104cf3:	39 06                	cmp    %eax,(%esi)
80104cf5:	75 39                	jne    80104d30 <sys_link+0xe0>
80104cf7:	8b 43 04             	mov    0x4(%ebx),%eax
80104cfa:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104cfe:	89 34 24             	mov    %esi,(%esp)
80104d01:	89 44 24 08          	mov    %eax,0x8(%esp)
80104d05:	e8 26 d1 ff ff       	call   80101e30 <dirlink>
80104d0a:	85 c0                	test   %eax,%eax
80104d0c:	78 22                	js     80104d30 <sys_link+0xe0>
  iunlockput(dp);
80104d0e:	89 34 24             	mov    %esi,(%esp)
80104d11:	e8 0a cc ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104d16:	89 1c 24             	mov    %ebx,(%esp)
80104d19:	e8 c2 ca ff ff       	call   801017e0 <iput>
  end_op();
80104d1e:	e8 6d de ff ff       	call   80102b90 <end_op>
}
80104d23:	83 c4 3c             	add    $0x3c,%esp
  return 0;
80104d26:	31 c0                	xor    %eax,%eax
}
80104d28:	5b                   	pop    %ebx
80104d29:	5e                   	pop    %esi
80104d2a:	5f                   	pop    %edi
...
80104d2d:	8d 76 00             	lea    0x0(%esi),%esi
    iunlockput(dp);
80104d30:	89 34 24             	mov    %esi,(%esp)
80104d33:	e8 e8 cb ff ff       	call   80101920 <iunlockput>
  ilock(ip);
80104d38:	89 1c 24             	mov    %ebx,(%esp)
80104d3b:	e8 80 c9 ff ff       	call   801016c0 <ilock>
  ip->nlink--;
80104d40:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104d45:	89 1c 24             	mov    %ebx,(%esp)
80104d48:	e8 b3 c8 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
...
80104d5a:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80104d76:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80104d79:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104d7c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d80:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d87:	e8 34 fa ff ff       	call   801047c0 <argstr>
80104d8c:	85 c0                	test   %eax,%eax
80104d8e:	0f 88 76 01 00 00    	js     80104f0a <sys_unlink+0x19a>
  begin_op();
80104d94:	e8 87 dd ff ff       	call   80102b20 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104d99:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104d9c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104d9f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104da3:	89 04 24             	mov    %eax,(%esp)
80104da6:	e8 85 d1 ff ff       	call   80101f30 <nameiparent>
80104dab:	85 c0                	test   %eax,%eax
80104dad:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104db0:	0f 84 4f 01 00 00    	je     80104f05 <sys_unlink+0x195>
  ilock(dp);
80104db6:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104db9:	89 34 24             	mov    %esi,(%esp)
80104dbc:	e8 ff c8 ff ff       	call   801016c0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104dc1:	c7 44 24 04 1c 76 10 	movl   $0x8010761c,0x4(%esp)
80104dc8:	80 
80104dc9:	89 1c 24             	mov    %ebx,(%esp)
80104dcc:	e8 cf cd ff ff       	call   80101ba0 <namecmp>
80104dd1:	85 c0                	test   %eax,%eax
80104dd3:	0f 84 21 01 00 00    	je     80104efa <sys_unlink+0x18a>
80104dd9:	c7 44 24 04 1b 76 10 	movl   $0x8010761b,0x4(%esp)
80104de0:	80 
80104de1:	89 1c 24             	mov    %ebx,(%esp)
80104de4:	e8 b7 cd ff ff       	call   80101ba0 <namecmp>
80104de9:	85 c0                	test   %eax,%eax
80104deb:	0f 84 09 01 00 00    	je     80104efa <sys_unlink+0x18a>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104df1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104df4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104df8:	89 44 24 08          	mov    %eax,0x8(%esp)
80104dfc:	89 34 24             	mov    %esi,(%esp)
80104dff:	e8 cc cd ff ff       	call   80101bd0 <dirlookup>
80104e04:	85 c0                	test   %eax,%eax
80104e06:	89 c3                	mov    %eax,%ebx
80104e08:	0f 84 ec 00 00 00    	je     80104efa <sys_unlink+0x18a>
  ilock(ip);
80104e0e:	89 04 24             	mov    %eax,(%esp)
80104e11:	e8 aa c8 ff ff       	call   801016c0 <ilock>
  if(ip->nlink < 1)
80104e16:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104e1b:	0f 8e 24 01 00 00    	jle    80104f45 <sys_unlink+0x1d5>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104e21:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e26:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104e29:	74 7d                	je     80104ea8 <sys_unlink+0x138>
  memset(&de, 0, sizeof(de));
80104e2b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104e32:	00 
80104e33:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104e3a:	00 
80104e3b:	89 34 24             	mov    %esi,(%esp)
80104e3e:	e8 fd f5 ff ff       	call   80104440 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104e43:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104e46:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104e4d:	00 
80104e4e:	89 74 24 04          	mov    %esi,0x4(%esp)
80104e52:	89 44 24 08          	mov    %eax,0x8(%esp)
80104e56:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104e59:	89 04 24             	mov    %eax,(%esp)
80104e5c:	e8 0f cc ff ff       	call   80101a70 <writei>
80104e61:	83 f8 10             	cmp    $0x10,%eax
80104e64:	0f 85 cf 00 00 00    	jne    80104f39 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80104e6a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e6f:	0f 84 a3 00 00 00    	je     80104f18 <sys_unlink+0x1a8>
  iunlockput(dp);
80104e75:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80104e88:	e8 73 c7 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104e8d:	89 1c 24             	mov    %ebx,(%esp)
80104e90:	e8 8b ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104e95:	e8 f6 dc ff ff       	call   80102b90 <end_op>
}
...
80104ea8:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80104eac:	0f 86 79 ff ff ff    	jbe    80104e2b <sys_unlink+0xbb>
80104eb2:	bf 20 00 00 00       	mov    $0x20,%edi
80104eb7:	eb 15                	jmp    80104ece <sys_unlink+0x15e>
80104eb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104ec0:	8d 57 10             	lea    0x10(%edi),%edx
80104ec3:	3b 53 58             	cmp    0x58(%ebx),%edx
80104ec6:	0f 83 5f ff ff ff    	jae    80104e2b <sys_unlink+0xbb>
80104ecc:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ece:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104ed5:	00 
80104ed6:	89 7c 24 08          	mov    %edi,0x8(%esp)
80104eda:	89 74 24 04          	mov    %esi,0x4(%esp)
80104ede:	89 1c 24             	mov    %ebx,(%esp)
80104ee1:	e8 8a ca ff ff       	call   80101970 <readi>
80104ee6:	83 f8 10             	cmp    $0x10,%eax
80104ee9:	75 42                	jne    80104f2d <sys_unlink+0x1bd>
    if(de.inum != 0)
80104eeb:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104ef0:	74 ce                	je     80104ec0 <sys_unlink+0x150>
    iunlockput(ip);
80104ef2:	89 1c 24             	mov    %ebx,(%esp)
80104ef5:	e8 26 ca ff ff       	call   80101920 <iunlockput>
  iunlockput(dp);
80104efa:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104efd:	89 04 24             	mov    %eax,(%esp)
80104f00:	e8 1b ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104f05:	e8 86 dc ff ff       	call   80102b90 <end_op>
}
...
80104f1b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80104f20:	89 04 24             	mov    %eax,(%esp)
80104f23:	e8 d8 c6 ff ff       	call   80101600 <iupdate>
80104f28:	e9 48 ff ff ff       	jmp    80104e75 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104f2d:	c7 04 24 40 76 10 80 	movl   $0x80107640,(%esp)
80104f34:	e8 27 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104f39:	c7 04 24 52 76 10 80 	movl   $0x80107652,(%esp)
80104f40:	e8 1b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104f45:	c7 04 24 2e 76 10 80 	movl   $0x8010762e,(%esp)
80104f4c:	e8 0f b4 ff ff       	call   80100360 <panic>
...
80104f69:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104f6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f70:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104f77:	e8 44 f8 ff ff       	call   801047c0 <argstr>
80104f7c:	85 c0                	test   %eax,%eax
80104f7e:	0f 88 d1 00 00 00    	js     80105055 <sys_open+0xf5>
80104f84:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104f87:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104f92:	e8 99 f7 ff ff       	call   80104730 <argint>
80104f97:	85 c0                	test   %eax,%eax
80104f99:	0f 88 b6 00 00 00    	js     80105055 <sys_open+0xf5>
    return -1;

  begin_op();
80104f9f:	e8 7c db ff ff       	call   80102b20 <begin_op>

  if(omode & O_CREATE){
80104fa4:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80104fa8:	0f 85 82 00 00 00    	jne    80105030 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80104fb4:	e8 57 cf ff ff       	call   80101f10 <namei>
80104fb9:	85 c0                	test   %eax,%eax
80104fbb:	89 c6                	mov    %eax,%esi
80104fbd:	0f 84 8d 00 00 00    	je     80105050 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
80104fc3:	89 04 24             	mov    %eax,(%esp)
80104fc6:	e8 f5 c6 ff ff       	call   801016c0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104fcb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104fd0:	0f 84 92 00 00 00    	je     80105068 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
80104fd6:	e8 95 bd ff ff       	call   80100d70 <filealloc>
80104fdb:	85 c0                	test   %eax,%eax
80104fdd:	89 c3                	mov    %eax,%ebx
80104fdf:	0f 84 93 00 00 00    	je     80105078 <sys_open+0x118>
80104fe5:	e8 86 f8 ff ff       	call   80104870 <fdalloc>
80104fea:	85 c0                	test   %eax,%eax
80104fec:	89 c7                	mov    %eax,%edi
80104fee:	0f 88 94 00 00 00    	js     80105088 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80104ff4:	89 34 24             	mov    %esi,(%esp)
80104ff7:	e8 a4 c7 ff ff       	call   801017a0 <iunlock>
  end_op();
80104ffc:	e8 8f db ff ff       	call   80102b90 <end_op>

  f->type = FD_INODE;
80105001:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105007:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
8010500a:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
8010500d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80105014:	89 c2                	mov    %eax,%edx
80105016:	83 e2 01             	and    $0x1,%edx
80105019:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010501c:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
8010501e:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
80105021:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105023:	0f 95 43 09          	setne  0x9(%ebx)
}
80105027:	83 c4 2c             	add    $0x2c,%esp
8010502a:	5b                   	pop    %ebx
8010502b:	5e                   	pop    %esi
8010502c:	5f                   	pop    %edi
8010502d:	5d                   	pop    %ebp
...
80105030:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105033:	31 c9                	xor    %ecx,%ecx
80105035:	ba 02 00 00 00       	mov    $0x2,%edx
8010503a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105041:	e8 6a f8 ff ff       	call   801048b0 <create>
    if(ip == 0){
80105046:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
80105048:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010504a:	75 8a                	jne    80104fd6 <sys_open+0x76>
8010504c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105050:	e8 3b db ff ff       	call   80102b90 <end_op>
}
80105055:	83 c4 2c             	add    $0x2c,%esp
    return -1;
...
801050b9:	e8 02 f7 ff ff       	call   801047c0 <argstr>
801050be:	85 c0                	test   %eax,%eax
801050c0:	78 2e                	js     801050f0 <sys_mkdir+0x50>
801050c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050c5:	31 c9                	xor    %ecx,%ecx
801050c7:	ba 01 00 00 00       	mov    $0x1,%edx
801050cc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801050d3:	e8 d8 f7 ff ff       	call   801048b0 <create>
801050d8:	85 c0                	test   %eax,%eax
801050da:	74 14                	je     801050f0 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105119:	e8 a2 f6 ff ff       	call   801047c0 <argstr>
8010511e:	85 c0                	test   %eax,%eax
80105120:	78 5e                	js     80105180 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80105122:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105125:	89 44 24 04          	mov    %eax,0x4(%esp)
80105129:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105130:	e8 fb f5 ff ff       	call   80104730 <argint>
  if((argstr(0, &path)) < 0 ||
80105135:	85 c0                	test   %eax,%eax
80105137:	78 47                	js     80105180 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
80105139:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010513c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105140:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105147:	e8 e4 f5 ff ff       	call   80104730 <argint>
     argint(1, &major) < 0 ||
8010514c:	85 c0                	test   %eax,%eax
8010514e:	78 30                	js     80105180 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105150:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
80105154:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80105159:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
8010515d:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80105160:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105163:	e8 48 f7 ff ff       	call   801048b0 <create>
80105168:	85 c0                	test   %eax,%eax
8010516a:	74 14                	je     80105180 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010516f:	e8 ac c7 ff ff       	call   80101920 <iunlockput>
  end_op();
80105174:	e8 17 da ff ff       	call   80102b90 <end_op>
  return 0;
...
80105195:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105198:	e8 13 e5 ff ff       	call   801036b0 <myproc>
...
801051a7:	89 44 24 04          	mov    %eax,0x4(%esp)
801051ab:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051b2:	e8 09 f6 ff ff       	call   801047c0 <argstr>
801051b7:	85 c0                	test   %eax,%eax
801051b9:	78 4a                	js     80105205 <sys_chdir+0x75>
801051bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051be:	89 04 24             	mov    %eax,(%esp)
801051c1:	e8 4a cd ff ff       	call   80101f10 <namei>
801051c6:	85 c0                	test   %eax,%eax
801051c8:	89 c3                	mov    %eax,%ebx
801051ca:	74 39                	je     80105205 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
801051cc:	89 04 24             	mov    %eax,(%esp)
801051cf:	e8 ec c4 ff ff       	call   801016c0 <ilock>
  if(ip->type != T_DIR){
801051d4:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
801051d9:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
801051dc:	75 22                	jne    80105200 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
801051de:	e8 bd c5 ff ff       	call   801017a0 <iunlock>
  iput(curproc->cwd);
801051e3:	8b 46 70             	mov    0x70(%esi),%eax
801051e6:	89 04 24             	mov    %eax,(%esp)
801051e9:	e8 f2 c5 ff ff       	call   801017e0 <iput>
  end_op();
801051ee:	e8 9d d9 ff ff       	call   80102b90 <end_op>
  curproc->cwd = ip;
  return 0;
801051f3:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
801051f5:	89 5e 70             	mov    %ebx,0x70(%esi)
}
...
80105226:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010522c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
80105232:	89 44 24 04          	mov    %eax,0x4(%esp)
80105236:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010523d:	e8 7e f5 ff ff       	call   801047c0 <argstr>
80105242:	85 c0                	test   %eax,%eax
80105244:	0f 88 84 00 00 00    	js     801052ce <sys_exec+0xae>
8010524a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105250:	89 44 24 04          	mov    %eax,0x4(%esp)
80105254:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010525b:	e8 d0 f4 ff ff       	call   80104730 <argint>
80105260:	85 c0                	test   %eax,%eax
80105262:	78 6a                	js     801052ce <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105264:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010526a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010526c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105273:	00 
80105274:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010527a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105281:	00 
80105282:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105288:	89 04 24             	mov    %eax,(%esp)
8010528b:	e8 b0 f1 ff ff       	call   80104440 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105290:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105296:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010529a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010529d:	89 04 24             	mov    %eax,(%esp)
801052a0:	e8 eb f3 ff ff       	call   80104690 <fetchint>
801052a5:	85 c0                	test   %eax,%eax
801052a7:	78 25                	js     801052ce <sys_exec+0xae>
      return -1;
    if(uarg == 0){
801052a9:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801052af:	85 c0                	test   %eax,%eax
801052b1:	74 2d                	je     801052e0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801052b3:	89 74 24 04          	mov    %esi,0x4(%esp)
801052b7:	89 04 24             	mov    %eax,(%esp)
801052ba:	e8 11 f4 ff ff       	call   801046d0 <fetchstr>
801052bf:	85 c0                	test   %eax,%eax
801052c1:	78 0b                	js     801052ce <sys_exec+0xae>
  for(i=0;; i++){
801052c3:	83 c3 01             	add    $0x1,%ebx
801052c6:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
801052c9:	83 fb 20             	cmp    $0x20,%ebx
801052cc:	75 c2                	jne    80105290 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
801052ce:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
801052ea:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
801052f0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801052f7:	00 00 00 00 
  return exec(path, argv);
801052fb:	89 04 24             	mov    %eax,(%esp)
801052fe:	e8 9d b6 ff ff       	call   801009a0 <exec>
}
80105303:	81 c4 ac 00 00 00    	add    $0xac,%esp
80105309:	5b                   	pop    %ebx
8010530a:	5e                   	pop    %esi
8010530b:	5f                   	pop    %edi
8010530c:	5d                   	pop    %ebp
...
80105317:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010531a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105321:	00 
80105322:	89 44 24 04          	mov    %eax,0x4(%esp)
80105326:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010532d:	e8 2e f4 ff ff       	call   80104760 <argptr>
80105332:	85 c0                	test   %eax,%eax
80105334:	78 6d                	js     801053a3 <sys_pipe+0x93>
    return -1;
...
80105343:	e8 38 de ff ff       	call   80103180 <pipealloc>
80105348:	85 c0                	test   %eax,%eax
8010534a:	78 57                	js     801053a3 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010534c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010534f:	e8 1c f5 ff ff       	call   80104870 <fdalloc>
80105354:	85 c0                	test   %eax,%eax
80105356:	89 c3                	mov    %eax,%ebx
80105358:	78 33                	js     8010538d <sys_pipe+0x7d>
8010535a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010535d:	e8 0e f5 ff ff       	call   80104870 <fdalloc>
80105362:	85 c0                	test   %eax,%eax
80105364:	78 1a                	js     80105380 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80105366:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105369:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
8010536b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010536e:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
...
80105379:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105380:	e8 2b e3 ff ff       	call   801036b0 <myproc>
80105385:	c7 44 98 30 00 00 00 	movl   $0x0,0x30(%eax,%ebx,4)
8010538c:	00 
    fileclose(rf);
8010538d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105390:	89 04 24             	mov    %eax,(%esp)
80105393:	e8 98 ba ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105398:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010539b:	89 04 24             	mov    %eax,(%esp)
8010539e:	e8 8d ba ff ff       	call   80100e30 <fileclose>
}
801053a3:	83 c4 24             	add    $0x24,%esp
    return -1;
...
801053b3:	5d                   	pop    %ebp
  return fork();
801053b4:	e9 a7 e4 ff ff       	jmp    80103860 <fork>
...
801053d4:	e8 57 f3 ff ff       	call   80104730 <argint>
801053d9:	85 c0                	test   %eax,%eax
801053db:	78 13                	js     801053f0 <sys_exit+0x30>
    return -1;
  }
  exit(status);
801053dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053e0:	89 04 24             	mov    %eax,(%esp)
801053e3:	e8 68 e7 ff ff       	call   80103b50 <exit>
...
80105409:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105410:	00 
80105411:	89 44 24 04          	mov    %eax,0x4(%esp)
80105415:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010541c:	e8 3f f3 ff ff       	call   80104760 <argptr>
80105421:	85 c0                	test   %eax,%eax
80105423:	78 13                	js     80105438 <sys_wait+0x38>
    return -1;
  }
...
8010542b:	e8 40 e9 ff ff       	call   80103d70 <wait>
}
80105430:	c9                   	leave  
80105431:	c3                   	ret    
...
80105454:	e8 d7 f2 ff ff       	call   80104730 <argint>
80105459:	85 c0                	test   %eax,%eax
8010545b:	78 53                	js     801054b0 <sys_waitpid+0x70>
    return -1;
  }
  char *status;
  if(argptr(1, &status,8)<0){
8010545d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105460:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105467:	00 
...
8010547a:	78 34                	js     801054b0 <sys_waitpid+0x70>
    return -1;
  }
  int options;
...
80105483:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010548a:	e8 a1 f2 ff ff       	call   80104730 <argint>
8010548f:	85 c0                	test   %eax,%eax
80105491:	78 1d                	js     801054b0 <sys_waitpid+0x70>
    return -1;
  }

  return waitpid(pid, (int*)status, options);
80105493:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105496:	89 44 24 08          	mov    %eax,0x8(%esp)
8010549a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010549d:	89 44 24 04          	mov    %eax,0x4(%esp)
801054a1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801054a4:	89 04 24             	mov    %eax,(%esp)
801054a7:	e8 b4 e9 ff ff       	call   80103e60 <waitpid>
}
801054ac:	c9                   	leave  
801054ad:	c3                   	ret    
...
801054d4:	e8 57 f2 ff ff       	call   80104730 <argint>
...
801054e3:	e8 98 e5 ff ff       	call   80103a80 <setpriority>
}
801054e8:	c9                   	leave  
801054e9:	c3                   	ret    
...
80105514:	e8 17 f2 ff ff       	call   80104730 <argint>
80105519:	85 c0                	test   %eax,%eax
8010551b:	78 13                	js     80105530 <sys_kill+0x30>
    return -1;
  return kill(pid);
8010551d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105520:	89 04 24             	mov    %eax,(%esp)
80105523:	e8 68 ea ff ff       	call   80103f90 <kill>
}
80105528:	c9                   	leave  
80105529:	c3                   	ret    
...
80105543:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105546:	e8 65 e1 ff ff       	call   801036b0 <myproc>
...
80105554:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;
...
80105565:	e8 c6 f1 ff ff       	call   80104730 <argint>
8010556a:	85 c0                	test   %eax,%eax
8010556c:	78 22                	js     80105590 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010556e:	e8 3d e1 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
80105573:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105576:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105578:	89 14 24             	mov    %edx,(%esp)
8010557b:	e8 70 e2 ff ff       	call   801037f0 <growproc>
80105580:	85 c0                	test   %eax,%eax
80105582:	78 0c                	js     80105590 <sys_sbrk+0x40>
    return -1;
  return addr;
...
80105595:	eb ef                	jmp    80105586 <sys_sbrk+0x36>
...
801055b5:	e8 76 f1 ff ff       	call   80104730 <argint>
801055ba:	85 c0                	test   %eax,%eax
801055bc:	78 7e                	js     8010563c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801055be:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801055c5:	e8 b6 ed ff ff       	call   80104380 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801055cd:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
801055d3:	85 d2                	test   %edx,%edx
801055d5:	75 29                	jne    80105600 <sys_sleep+0x60>
801055d7:	eb 4f                	jmp    80105628 <sys_sleep+0x88>
...
801055e0:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
801055e7:	80 
801055e8:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
801055ef:	e8 cc e6 ff ff       	call   80103cc0 <sleep>
  while(ticks - ticks0 < n){
801055f4:	a1 a0 56 11 80       	mov    0x801156a0,%eax
801055f9:	29 d8                	sub    %ebx,%eax
801055fb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801055fe:	73 28                	jae    80105628 <sys_sleep+0x88>
    if(myproc()->killed){
80105600:	e8 ab e0 ff ff       	call   801036b0 <myproc>
80105605:	8b 40 2c             	mov    0x2c(%eax),%eax
80105608:	85 c0                	test   %eax,%eax
8010560a:	74 d4                	je     801055e0 <sys_sleep+0x40>
      release(&tickslock);
8010560c:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105613:	e8 d8 ed ff ff       	call   801043f0 <release>
      return -1;
...
8010561d:	83 c4 24             	add    $0x24,%esp
80105620:	5b                   	pop    %ebx
80105621:	5d                   	pop    %ebp
80105622:	c3                   	ret    
80105623:	90                   	nop
80105624:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105628:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010562f:	e8 bc ed ff ff       	call   801043f0 <release>
}
80105634:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80105641:	eb da                	jmp    8010561d <sys_sleep+0x7d>
...
80105654:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105657:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010565e:	e8 1d ed ff ff       	call   80104380 <acquire>
  xticks = ticks;
80105663:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105669:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105670:	e8 7b ed ff ff       	call   801043f0 <release>
  return xticks;
}
80105675:	83 c4 14             	add    $0x14,%esp
80105678:	89 d8                	mov    %ebx,%eax
8010567a:	5b                   	pop    %ebx
8010567b:	5d                   	pop    %ebp
8010567c:	c3                   	ret    
...
801056b4:	66 89 0c c5 a2 4e 11 	mov    %cx,-0x7feeb15e(,%eax,8)
801056bb:	80 
801056bc:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
801056c3:	00 
801056c4:	c6 04 c5 a5 4e 11 80 	movb   $0x8e,-0x7feeb15b(,%eax,8)
801056cb:	8e 
801056cc:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
801056d3:	80 
801056d4:	c1 ea 10             	shr    $0x10,%edx
801056d7:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
801056de:	80 
  for(i = 0; i < 256; i++)
...
80105700:	80 
80105701:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105708:	66 89 15 a2 50 11 80 	mov    %dx,0x801150a2
8010570f:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105715:	c1 e8 10             	shr    $0x10,%eax
80105718:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
8010571f:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
80105726:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010572c:	e8 df ea ff ff       	call   80104210 <initlock>
}
80105731:	c9                   	leave  
80105732:	c3                   	ret    
...
8010574b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010574f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105798:	e8 13 df ff ff       	call   801036b0 <myproc>
...
801057bc:	e8 cf de ff ff       	call   80103690 <cpuid>
...
801057cc:	e8 df de ff ff       	call   801036b0 <myproc>
801057d1:	89 45 e0             	mov    %eax,-0x20(%ebp)
801057d4:	e8 d7 de ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801057ee:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801057f1:	83 c6 74             	add    $0x74,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
8010580e:	e8 3d ae ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
80105813:	e8 98 de ff ff       	call   801036b0 <myproc>
80105818:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
8010581f:	90                   	nop
  }
...
80105829:	e8 82 de ff ff       	call   801036b0 <myproc>
8010582e:	8b 50 2c             	mov    0x2c(%eax),%edx
...
80105835:	e8 76 de ff ff       	call   801036b0 <myproc>
...
80105849:	74 55                	je     801058a0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010584b:	e8 60 de ff ff       	call   801036b0 <myproc>
80105850:	85 c0                	test   %eax,%eax
80105852:	74 1d                	je     80105871 <trap+0x101>
80105854:	e8 57 de ff ff       	call   801036b0 <myproc>
80105859:	8b 40 2c             	mov    0x2c(%eax),%eax
...
8010588b:	75 a8                	jne    80105835 <trap+0xc5>
    exit(1);
8010588d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
...
801058a4:	75 a5                	jne    8010584b <trap+0xdb>
    yield();
801058a6:	e8 d5 e3 ff ff       	call   80103c80 <yield>
801058ab:	eb 9e                	jmp    8010584b <trap+0xdb>
801058ad:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801058b0:	e8 db dd ff ff       	call   80103690 <cpuid>
...
801058f7:	e8 94 dd ff ff       	call   80103690 <cpuid>
...
80105929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105930:	e8 7b dd ff ff       	call   801036b0 <myproc>
80105935:	8b 70 2c             	mov    0x2c(%eax),%esi
80105938:	85 f6                	test   %esi,%esi
8010593a:	75 34                	jne    80105970 <trap+0x200>
    myproc()->tf = tf;
8010593c:	e8 6f dd ff ff       	call   801036b0 <myproc>
80105941:	89 58 20             	mov    %ebx,0x20(%eax)
    syscall();
80105944:	e8 b7 ee ff ff       	call   80104800 <syscall>
    if(myproc()->killed)
80105949:	e8 62 dd ff ff       	call   801036b0 <myproc>
8010594e:	8b 48 2c             	mov    0x2c(%eax),%ecx
80105951:	85 c9                	test   %ecx,%ecx
80105953:	0f 84 18 ff ff ff    	je     80105871 <trap+0x101>
      exit(1);
80105959:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
...
8010597e:	66 90                	xchg   %ax,%ax
      acquire(&tickslock);
80105980:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105987:	e8 f4 e9 ff ff       	call   80104380 <acquire>
      wakeup(&ticks);
8010598c:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105993:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
8010599a:	e8 81 e5 ff ff       	call   80103f20 <wakeup>
      release(&tickslock);
8010599f:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801059a6:	e8 45 ea ff ff       	call   801043f0 <release>
801059ab:	e9 0d ff ff ff       	jmp    801058bd <trap+0x14d>
801059b0:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059b3:	8b 73 38             	mov    0x38(%ebx),%esi
801059b6:	e8 d5 dc ff ff       	call   80103690 <cpuid>
...
80105b26:	6a 00                	push   $0x0
  jmp alltraps
80105b28:	e9 50 fb ff ff       	jmp    8010567d <alltraps>
...
80105b2f:	6a 01                	push   $0x1
  jmp alltraps
80105b31:	e9 47 fb ff ff       	jmp    8010567d <alltraps>
...
80105b38:	6a 02                	push   $0x2
  jmp alltraps
80105b3a:	e9 3e fb ff ff       	jmp    8010567d <alltraps>
...
80105b41:	6a 03                	push   $0x3
  jmp alltraps
80105b43:	e9 35 fb ff ff       	jmp    8010567d <alltraps>
...
80105b4a:	6a 04                	push   $0x4
  jmp alltraps
80105b4c:	e9 2c fb ff ff       	jmp    8010567d <alltraps>
...
80105b53:	6a 05                	push   $0x5
  jmp alltraps
80105b55:	e9 23 fb ff ff       	jmp    8010567d <alltraps>
...
80105b5c:	6a 06                	push   $0x6
  jmp alltraps
80105b5e:	e9 1a fb ff ff       	jmp    8010567d <alltraps>
...
80105b65:	6a 07                	push   $0x7
  jmp alltraps
80105b67:	e9 11 fb ff ff       	jmp    8010567d <alltraps>
...
80105b6c:	6a 08                	push   $0x8
  jmp alltraps
80105b6e:	e9 0a fb ff ff       	jmp    8010567d <alltraps>
...
80105b75:	6a 09                	push   $0x9
  jmp alltraps
80105b77:	e9 01 fb ff ff       	jmp    8010567d <alltraps>
...
80105b7c:	6a 0a                	push   $0xa
  jmp alltraps
80105b7e:	e9 fa fa ff ff       	jmp    8010567d <alltraps>
...
80105b83:	6a 0b                	push   $0xb
  jmp alltraps
80105b85:	e9 f3 fa ff ff       	jmp    8010567d <alltraps>
...
80105b8a:	6a 0c                	push   $0xc
  jmp alltraps
80105b8c:	e9 ec fa ff ff       	jmp    8010567d <alltraps>
...
80105b91:	6a 0d                	push   $0xd
  jmp alltraps
80105b93:	e9 e5 fa ff ff       	jmp    8010567d <alltraps>
...
80105b98:	6a 0e                	push   $0xe
  jmp alltraps
80105b9a:	e9 de fa ff ff       	jmp    8010567d <alltraps>
...
80105ba1:	6a 0f                	push   $0xf
  jmp alltraps
80105ba3:	e9 d5 fa ff ff       	jmp    8010567d <alltraps>
...
80105baa:	6a 10                	push   $0x10
  jmp alltraps
80105bac:	e9 cc fa ff ff       	jmp    8010567d <alltraps>
...
80105bb1:	6a 11                	push   $0x11
  jmp alltraps
80105bb3:	e9 c5 fa ff ff       	jmp    8010567d <alltraps>
...
80105bba:	6a 12                	push   $0x12
  jmp alltraps
80105bbc:	e9 bc fa ff ff       	jmp    8010567d <alltraps>
...
80105bc3:	6a 13                	push   $0x13
  jmp alltraps
80105bc5:	e9 b3 fa ff ff       	jmp    8010567d <alltraps>
...
80105bcc:	6a 14                	push   $0x14
  jmp alltraps
80105bce:	e9 aa fa ff ff       	jmp    8010567d <alltraps>
...
80105bd5:	6a 15                	push   $0x15
  jmp alltraps
80105bd7:	e9 a1 fa ff ff       	jmp    8010567d <alltraps>
...
80105bde:	6a 16                	push   $0x16
  jmp alltraps
80105be0:	e9 98 fa ff ff       	jmp    8010567d <alltraps>
...
80105be7:	6a 17                	push   $0x17
  jmp alltraps
80105be9:	e9 8f fa ff ff       	jmp    8010567d <alltraps>
...
80105bf0:	6a 18                	push   $0x18
  jmp alltraps
80105bf2:	e9 86 fa ff ff       	jmp    8010567d <alltraps>
...
80105bf9:	6a 19                	push   $0x19
  jmp alltraps
80105bfb:	e9 7d fa ff ff       	jmp    8010567d <alltraps>
...
80105c02:	6a 1a                	push   $0x1a
  jmp alltraps
80105c04:	e9 74 fa ff ff       	jmp    8010567d <alltraps>
...
80105c0b:	6a 1b                	push   $0x1b
  jmp alltraps
80105c0d:	e9 6b fa ff ff       	jmp    8010567d <alltraps>
...
80105c14:	6a 1c                	push   $0x1c
  jmp alltraps
80105c16:	e9 62 fa ff ff       	jmp    8010567d <alltraps>
...
80105c1d:	6a 1d                	push   $0x1d
  jmp alltraps
80105c1f:	e9 59 fa ff ff       	jmp    8010567d <alltraps>
...
80105c26:	6a 1e                	push   $0x1e
  jmp alltraps
80105c28:	e9 50 fa ff ff       	jmp    8010567d <alltraps>
...
80105c2f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c31:	e9 47 fa ff ff       	jmp    8010567d <alltraps>
...
80105c38:	6a 20                	push   $0x20
  jmp alltraps
80105c3a:	e9 3e fa ff ff       	jmp    8010567d <alltraps>
...
80105c41:	6a 21                	push   $0x21
  jmp alltraps
80105c43:	e9 35 fa ff ff       	jmp    8010567d <alltraps>
...
80105c4a:	6a 22                	push   $0x22
  jmp alltraps
80105c4c:	e9 2c fa ff ff       	jmp    8010567d <alltraps>
...
80105c53:	6a 23                	push   $0x23
  jmp alltraps
80105c55:	e9 23 fa ff ff       	jmp    8010567d <alltraps>
...
80105c5c:	6a 24                	push   $0x24
  jmp alltraps
80105c5e:	e9 1a fa ff ff       	jmp    8010567d <alltraps>
...
80105c65:	6a 25                	push   $0x25
  jmp alltraps
80105c67:	e9 11 fa ff ff       	jmp    8010567d <alltraps>
...
80105c6e:	6a 26                	push   $0x26
  jmp alltraps
80105c70:	e9 08 fa ff ff       	jmp    8010567d <alltraps>
...
80105c77:	6a 27                	push   $0x27
  jmp alltraps
80105c79:	e9 ff f9 ff ff       	jmp    8010567d <alltraps>
...
80105c80:	6a 28                	push   $0x28
  jmp alltraps
80105c82:	e9 f6 f9 ff ff       	jmp    8010567d <alltraps>
...
80105c89:	6a 29                	push   $0x29
  jmp alltraps
80105c8b:	e9 ed f9 ff ff       	jmp    8010567d <alltraps>
...
80105c92:	6a 2a                	push   $0x2a
  jmp alltraps
80105c94:	e9 e4 f9 ff ff       	jmp    8010567d <alltraps>
...
80105c9b:	6a 2b                	push   $0x2b
  jmp alltraps
80105c9d:	e9 db f9 ff ff       	jmp    8010567d <alltraps>
...
80105ca4:	6a 2c                	push   $0x2c
  jmp alltraps
80105ca6:	e9 d2 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cad:	6a 2d                	push   $0x2d
  jmp alltraps
80105caf:	e9 c9 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cb6:	6a 2e                	push   $0x2e
  jmp alltraps
80105cb8:	e9 c0 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cbf:	6a 2f                	push   $0x2f
  jmp alltraps
80105cc1:	e9 b7 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cc8:	6a 30                	push   $0x30
  jmp alltraps
80105cca:	e9 ae f9 ff ff       	jmp    8010567d <alltraps>
...
80105cd1:	6a 31                	push   $0x31
  jmp alltraps
80105cd3:	e9 a5 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cda:	6a 32                	push   $0x32
  jmp alltraps
80105cdc:	e9 9c f9 ff ff       	jmp    8010567d <alltraps>
...
80105ce3:	6a 33                	push   $0x33
  jmp alltraps
80105ce5:	e9 93 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cec:	6a 34                	push   $0x34
  jmp alltraps
80105cee:	e9 8a f9 ff ff       	jmp    8010567d <alltraps>
...
80105cf5:	6a 35                	push   $0x35
  jmp alltraps
80105cf7:	e9 81 f9 ff ff       	jmp    8010567d <alltraps>
...
80105cfe:	6a 36                	push   $0x36
  jmp alltraps
80105d00:	e9 78 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d07:	6a 37                	push   $0x37
  jmp alltraps
80105d09:	e9 6f f9 ff ff       	jmp    8010567d <alltraps>
...
80105d10:	6a 38                	push   $0x38
  jmp alltraps
80105d12:	e9 66 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d19:	6a 39                	push   $0x39
  jmp alltraps
80105d1b:	e9 5d f9 ff ff       	jmp    8010567d <alltraps>
...
80105d22:	6a 3a                	push   $0x3a
  jmp alltraps
80105d24:	e9 54 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d2b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d2d:	e9 4b f9 ff ff       	jmp    8010567d <alltraps>
...
80105d34:	6a 3c                	push   $0x3c
  jmp alltraps
80105d36:	e9 42 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d3d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d3f:	e9 39 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d46:	6a 3e                	push   $0x3e
  jmp alltraps
80105d48:	e9 30 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d4f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d51:	e9 27 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d58:	6a 40                	push   $0x40
  jmp alltraps
80105d5a:	e9 1e f9 ff ff       	jmp    8010567d <alltraps>
...
80105d61:	6a 41                	push   $0x41
  jmp alltraps
80105d63:	e9 15 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d6a:	6a 42                	push   $0x42
  jmp alltraps
80105d6c:	e9 0c f9 ff ff       	jmp    8010567d <alltraps>
...
80105d73:	6a 43                	push   $0x43
  jmp alltraps
80105d75:	e9 03 f9 ff ff       	jmp    8010567d <alltraps>
...
80105d7c:	6a 44                	push   $0x44
  jmp alltraps
80105d7e:	e9 fa f8 ff ff       	jmp    8010567d <alltraps>
...
80105d85:	6a 45                	push   $0x45
  jmp alltraps
80105d87:	e9 f1 f8 ff ff       	jmp    8010567d <alltraps>
...
80105d8e:	6a 46                	push   $0x46
  jmp alltraps
80105d90:	e9 e8 f8 ff ff       	jmp    8010567d <alltraps>
...
80105d97:	6a 47                	push   $0x47
  jmp alltraps
80105d99:	e9 df f8 ff ff       	jmp    8010567d <alltraps>
...
80105da0:	6a 48                	push   $0x48
  jmp alltraps
80105da2:	e9 d6 f8 ff ff       	jmp    8010567d <alltraps>
...
80105da9:	6a 49                	push   $0x49
  jmp alltraps
80105dab:	e9 cd f8 ff ff       	jmp    8010567d <alltraps>
...
80105db2:	6a 4a                	push   $0x4a
  jmp alltraps
80105db4:	e9 c4 f8 ff ff       	jmp    8010567d <alltraps>
...
80105dbb:	6a 4b                	push   $0x4b
  jmp alltraps
80105dbd:	e9 bb f8 ff ff       	jmp    8010567d <alltraps>
...
80105dc4:	6a 4c                	push   $0x4c
  jmp alltraps
80105dc6:	e9 b2 f8 ff ff       	jmp    8010567d <alltraps>
...
80105dcd:	6a 4d                	push   $0x4d
  jmp alltraps
80105dcf:	e9 a9 f8 ff ff       	jmp    8010567d <alltraps>
...
80105dd6:	6a 4e                	push   $0x4e
  jmp alltraps
80105dd8:	e9 a0 f8 ff ff       	jmp    8010567d <alltraps>
...
80105ddf:	6a 4f                	push   $0x4f
  jmp alltraps
80105de1:	e9 97 f8 ff ff       	jmp    8010567d <alltraps>
...
80105de8:	6a 50                	push   $0x50
  jmp alltraps
80105dea:	e9 8e f8 ff ff       	jmp    8010567d <alltraps>
...
80105df1:	6a 51                	push   $0x51
  jmp alltraps
80105df3:	e9 85 f8 ff ff       	jmp    8010567d <alltraps>
...
80105dfa:	6a 52                	push   $0x52
  jmp alltraps
80105dfc:	e9 7c f8 ff ff       	jmp    8010567d <alltraps>
...
80105e03:	6a 53                	push   $0x53
  jmp alltraps
80105e05:	e9 73 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e0c:	6a 54                	push   $0x54
  jmp alltraps
80105e0e:	e9 6a f8 ff ff       	jmp    8010567d <alltraps>
...
80105e15:	6a 55                	push   $0x55
  jmp alltraps
80105e17:	e9 61 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e1e:	6a 56                	push   $0x56
  jmp alltraps
80105e20:	e9 58 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e27:	6a 57                	push   $0x57
  jmp alltraps
80105e29:	e9 4f f8 ff ff       	jmp    8010567d <alltraps>
...
80105e30:	6a 58                	push   $0x58
  jmp alltraps
80105e32:	e9 46 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e39:	6a 59                	push   $0x59
  jmp alltraps
80105e3b:	e9 3d f8 ff ff       	jmp    8010567d <alltraps>
...
80105e42:	6a 5a                	push   $0x5a
  jmp alltraps
80105e44:	e9 34 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e4b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e4d:	e9 2b f8 ff ff       	jmp    8010567d <alltraps>
...
80105e54:	6a 5c                	push   $0x5c
  jmp alltraps
80105e56:	e9 22 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e5d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e5f:	e9 19 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e66:	6a 5e                	push   $0x5e
  jmp alltraps
80105e68:	e9 10 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e6f:	6a 5f                	push   $0x5f
  jmp alltraps
80105e71:	e9 07 f8 ff ff       	jmp    8010567d <alltraps>
...
80105e78:	6a 60                	push   $0x60
  jmp alltraps
80105e7a:	e9 fe f7 ff ff       	jmp    8010567d <alltraps>
...
80105e81:	6a 61                	push   $0x61
  jmp alltraps
80105e83:	e9 f5 f7 ff ff       	jmp    8010567d <alltraps>
...
80105e8a:	6a 62                	push   $0x62
  jmp alltraps
80105e8c:	e9 ec f7 ff ff       	jmp    8010567d <alltraps>
...
80105e93:	6a 63                	push   $0x63
  jmp alltraps
80105e95:	e9 e3 f7 ff ff       	jmp    8010567d <alltraps>
...
80105e9c:	6a 64                	push   $0x64
  jmp alltraps
80105e9e:	e9 da f7 ff ff       	jmp    8010567d <alltraps>
...
80105ea5:	6a 65                	push   $0x65
  jmp alltraps
80105ea7:	e9 d1 f7 ff ff       	jmp    8010567d <alltraps>
...
80105eae:	6a 66                	push   $0x66
  jmp alltraps
80105eb0:	e9 c8 f7 ff ff       	jmp    8010567d <alltraps>
...
80105eb7:	6a 67                	push   $0x67
  jmp alltraps
80105eb9:	e9 bf f7 ff ff       	jmp    8010567d <alltraps>
...
80105ec0:	6a 68                	push   $0x68
  jmp alltraps
80105ec2:	e9 b6 f7 ff ff       	jmp    8010567d <alltraps>
...
80105ec9:	6a 69                	push   $0x69
  jmp alltraps
80105ecb:	e9 ad f7 ff ff       	jmp    8010567d <alltraps>
...
80105ed2:	6a 6a                	push   $0x6a
  jmp alltraps
80105ed4:	e9 a4 f7 ff ff       	jmp    8010567d <alltraps>
...
80105edb:	6a 6b                	push   $0x6b
  jmp alltraps
80105edd:	e9 9b f7 ff ff       	jmp    8010567d <alltraps>
...
80105ee4:	6a 6c                	push   $0x6c
  jmp alltraps
80105ee6:	e9 92 f7 ff ff       	jmp    8010567d <alltraps>
...
80105eed:	6a 6d                	push   $0x6d
  jmp alltraps
80105eef:	e9 89 f7 ff ff       	jmp    8010567d <alltraps>
...
80105ef6:	6a 6e                	push   $0x6e
  jmp alltraps
80105ef8:	e9 80 f7 ff ff       	jmp    8010567d <alltraps>
...
80105eff:	6a 6f                	push   $0x6f
  jmp alltraps
80105f01:	e9 77 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f08:	6a 70                	push   $0x70
  jmp alltraps
80105f0a:	e9 6e f7 ff ff       	jmp    8010567d <alltraps>
...
80105f11:	6a 71                	push   $0x71
  jmp alltraps
80105f13:	e9 65 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f1a:	6a 72                	push   $0x72
  jmp alltraps
80105f1c:	e9 5c f7 ff ff       	jmp    8010567d <alltraps>
...
80105f23:	6a 73                	push   $0x73
  jmp alltraps
80105f25:	e9 53 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f2c:	6a 74                	push   $0x74
  jmp alltraps
80105f2e:	e9 4a f7 ff ff       	jmp    8010567d <alltraps>
...
80105f35:	6a 75                	push   $0x75
  jmp alltraps
80105f37:	e9 41 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f3e:	6a 76                	push   $0x76
  jmp alltraps
80105f40:	e9 38 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f47:	6a 77                	push   $0x77
  jmp alltraps
80105f49:	e9 2f f7 ff ff       	jmp    8010567d <alltraps>
...
80105f50:	6a 78                	push   $0x78
  jmp alltraps
80105f52:	e9 26 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f59:	6a 79                	push   $0x79
  jmp alltraps
80105f5b:	e9 1d f7 ff ff       	jmp    8010567d <alltraps>
...
80105f62:	6a 7a                	push   $0x7a
  jmp alltraps
80105f64:	e9 14 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f6b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f6d:	e9 0b f7 ff ff       	jmp    8010567d <alltraps>
...
80105f74:	6a 7c                	push   $0x7c
  jmp alltraps
80105f76:	e9 02 f7 ff ff       	jmp    8010567d <alltraps>
...
80105f7d:	6a 7d                	push   $0x7d
  jmp alltraps
80105f7f:	e9 f9 f6 ff ff       	jmp    8010567d <alltraps>
...
80105f86:	6a 7e                	push   $0x7e
  jmp alltraps
80105f88:	e9 f0 f6 ff ff       	jmp    8010567d <alltraps>
...
80105f8f:	6a 7f                	push   $0x7f
  jmp alltraps
80105f91:	e9 e7 f6 ff ff       	jmp    8010567d <alltraps>
...
80105f98:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f9d:	e9 db f6 ff ff       	jmp    8010567d <alltraps>
...
80105fa4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fa9:	e9 cf f6 ff ff       	jmp    8010567d <alltraps>
...
80105fb0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fb5:	e9 c3 f6 ff ff       	jmp    8010567d <alltraps>
...
80105fbc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fc1:	e9 b7 f6 ff ff       	jmp    8010567d <alltraps>
...
80105fc8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fcd:	e9 ab f6 ff ff       	jmp    8010567d <alltraps>
...
80105fd4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fd9:	e9 9f f6 ff ff       	jmp    8010567d <alltraps>
...
80105fe0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fe5:	e9 93 f6 ff ff       	jmp    8010567d <alltraps>
...
80105fec:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105ff1:	e9 87 f6 ff ff       	jmp    8010567d <alltraps>
...
80105ff8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105ffd:	e9 7b f6 ff ff       	jmp    8010567d <alltraps>
...
80106004:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106009:	e9 6f f6 ff ff       	jmp    8010567d <alltraps>
...
80106010:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106015:	e9 63 f6 ff ff       	jmp    8010567d <alltraps>
...
8010601c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106021:	e9 57 f6 ff ff       	jmp    8010567d <alltraps>
...
80106028:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010602d:	e9 4b f6 ff ff       	jmp    8010567d <alltraps>
...
80106034:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106039:	e9 3f f6 ff ff       	jmp    8010567d <alltraps>
...
80106040:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106045:	e9 33 f6 ff ff       	jmp    8010567d <alltraps>
...
8010604c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106051:	e9 27 f6 ff ff       	jmp    8010567d <alltraps>
...
80106058:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010605d:	e9 1b f6 ff ff       	jmp    8010567d <alltraps>
...
80106064:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106069:	e9 0f f6 ff ff       	jmp    8010567d <alltraps>
...
80106070:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106075:	e9 03 f6 ff ff       	jmp    8010567d <alltraps>
...
8010607c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106081:	e9 f7 f5 ff ff       	jmp    8010567d <alltraps>
...
80106088:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010608d:	e9 eb f5 ff ff       	jmp    8010567d <alltraps>
...
80106094:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106099:	e9 df f5 ff ff       	jmp    8010567d <alltraps>
...
801060a0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060a5:	e9 d3 f5 ff ff       	jmp    8010567d <alltraps>
...
801060ac:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060b1:	e9 c7 f5 ff ff       	jmp    8010567d <alltraps>
...
801060b8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060bd:	e9 bb f5 ff ff       	jmp    8010567d <alltraps>
...
801060c4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060c9:	e9 af f5 ff ff       	jmp    8010567d <alltraps>
...
801060d0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060d5:	e9 a3 f5 ff ff       	jmp    8010567d <alltraps>
...
801060dc:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060e1:	e9 97 f5 ff ff       	jmp    8010567d <alltraps>
...
801060e8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060ed:	e9 8b f5 ff ff       	jmp    8010567d <alltraps>
...
801060f4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060f9:	e9 7f f5 ff ff       	jmp    8010567d <alltraps>
...
80106100:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106105:	e9 73 f5 ff ff       	jmp    8010567d <alltraps>
...
8010610c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106111:	e9 67 f5 ff ff       	jmp    8010567d <alltraps>
...
80106118:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010611d:	e9 5b f5 ff ff       	jmp    8010567d <alltraps>
...
80106124:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106129:	e9 4f f5 ff ff       	jmp    8010567d <alltraps>
...
80106130:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106135:	e9 43 f5 ff ff       	jmp    8010567d <alltraps>
...
8010613c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106141:	e9 37 f5 ff ff       	jmp    8010567d <alltraps>
...
80106148:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010614d:	e9 2b f5 ff ff       	jmp    8010567d <alltraps>
...
80106154:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106159:	e9 1f f5 ff ff       	jmp    8010567d <alltraps>
...
80106160:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106165:	e9 13 f5 ff ff       	jmp    8010567d <alltraps>
...
8010616c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106171:	e9 07 f5 ff ff       	jmp    8010567d <alltraps>
...
80106178:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010617d:	e9 fb f4 ff ff       	jmp    8010567d <alltraps>
...
80106184:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106189:	e9 ef f4 ff ff       	jmp    8010567d <alltraps>
...
80106190:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106195:	e9 e3 f4 ff ff       	jmp    8010567d <alltraps>
...
8010619c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061a1:	e9 d7 f4 ff ff       	jmp    8010567d <alltraps>
...
801061a8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061ad:	e9 cb f4 ff ff       	jmp    8010567d <alltraps>
...
801061b4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061b9:	e9 bf f4 ff ff       	jmp    8010567d <alltraps>
...
801061c0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061c5:	e9 b3 f4 ff ff       	jmp    8010567d <alltraps>
...
801061cc:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061d1:	e9 a7 f4 ff ff       	jmp    8010567d <alltraps>
...
801061d8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061dd:	e9 9b f4 ff ff       	jmp    8010567d <alltraps>
...
801061e4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061e9:	e9 8f f4 ff ff       	jmp    8010567d <alltraps>
...
801061f0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061f5:	e9 83 f4 ff ff       	jmp    8010567d <alltraps>
...
801061fc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106201:	e9 77 f4 ff ff       	jmp    8010567d <alltraps>
...
80106208:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010620d:	e9 6b f4 ff ff       	jmp    8010567d <alltraps>
...
80106214:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106219:	e9 5f f4 ff ff       	jmp    8010567d <alltraps>
...
80106220:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106225:	e9 53 f4 ff ff       	jmp    8010567d <alltraps>
...
8010622c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106231:	e9 47 f4 ff ff       	jmp    8010567d <alltraps>
...
80106238:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010623d:	e9 3b f4 ff ff       	jmp    8010567d <alltraps>
...
80106244:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106249:	e9 2f f4 ff ff       	jmp    8010567d <alltraps>
...
80106250:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106255:	e9 23 f4 ff ff       	jmp    8010567d <alltraps>
...
8010625c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106261:	e9 17 f4 ff ff       	jmp    8010567d <alltraps>
...
80106268:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010626d:	e9 0b f4 ff ff       	jmp    8010567d <alltraps>
...
80106274:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106279:	e9 ff f3 ff ff       	jmp    8010567d <alltraps>
...
80106280:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106285:	e9 f3 f3 ff ff       	jmp    8010567d <alltraps>
...
8010628c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106291:	e9 e7 f3 ff ff       	jmp    8010567d <alltraps>
...
80106298:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010629d:	e9 db f3 ff ff       	jmp    8010567d <alltraps>
...
801062a4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062a9:	e9 cf f3 ff ff       	jmp    8010567d <alltraps>
...
801062b0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062b5:	e9 c3 f3 ff ff       	jmp    8010567d <alltraps>
...
801062bc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062c1:	e9 b7 f3 ff ff       	jmp    8010567d <alltraps>
...
801062c8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062cd:	e9 ab f3 ff ff       	jmp    8010567d <alltraps>
...
801062d4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062d9:	e9 9f f3 ff ff       	jmp    8010567d <alltraps>
...
801062e0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062e5:	e9 93 f3 ff ff       	jmp    8010567d <alltraps>
...
801062ec:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062f1:	e9 87 f3 ff ff       	jmp    8010567d <alltraps>
...
801062f8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062fd:	e9 7b f3 ff ff       	jmp    8010567d <alltraps>
...
80106304:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106309:	e9 6f f3 ff ff       	jmp    8010567d <alltraps>
...
80106310:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106315:	e9 63 f3 ff ff       	jmp    8010567d <alltraps>
...
8010631c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106321:	e9 57 f3 ff ff       	jmp    8010567d <alltraps>
...
80106328:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010632d:	e9 4b f3 ff ff       	jmp    8010567d <alltraps>
...
80106334:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106339:	e9 3f f3 ff ff       	jmp    8010567d <alltraps>
...
80106340:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106345:	e9 33 f3 ff ff       	jmp    8010567d <alltraps>
...
8010634c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106351:	e9 27 f3 ff ff       	jmp    8010567d <alltraps>
...
80106358:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010635d:	e9 1b f3 ff ff       	jmp    8010567d <alltraps>
...
80106364:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106369:	e9 0f f3 ff ff       	jmp    8010567d <alltraps>
...
80106370:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106375:	e9 03 f3 ff ff       	jmp    8010567d <alltraps>
...
8010637c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106381:	e9 f7 f2 ff ff       	jmp    8010567d <alltraps>
...
80106388:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010638d:	e9 eb f2 ff ff       	jmp    8010567d <alltraps>
...
80106394:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106399:	e9 df f2 ff ff       	jmp    8010567d <alltraps>
...
801063a0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063a5:	e9 d3 f2 ff ff       	jmp    8010567d <alltraps>
...
801063ac:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063b1:	e9 c7 f2 ff ff       	jmp    8010567d <alltraps>
...
801063b8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063bd:	e9 bb f2 ff ff       	jmp    8010567d <alltraps>
...
801063c4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063c9:	e9 af f2 ff ff       	jmp    8010567d <alltraps>
...
801063d0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063d5:	e9 a3 f2 ff ff       	jmp    8010567d <alltraps>
...
801063dc:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063e1:	e9 97 f2 ff ff       	jmp    8010567d <alltraps>
...
801063e8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063ed:	e9 8b f2 ff ff       	jmp    8010567d <alltraps>
...
801063f4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063f9:	e9 7f f2 ff ff       	jmp    8010567d <alltraps>
...
80106400:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106405:	e9 73 f2 ff ff       	jmp    8010567d <alltraps>
...
8010640c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106411:	e9 67 f2 ff ff       	jmp    8010567d <alltraps>
...
80106418:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010641d:	e9 5b f2 ff ff       	jmp    8010567d <alltraps>
...
80106424:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106429:	e9 4f f2 ff ff       	jmp    8010567d <alltraps>
...
80106430:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106435:	e9 43 f2 ff ff       	jmp    8010567d <alltraps>
...
8010643c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106441:	e9 37 f2 ff ff       	jmp    8010567d <alltraps>
...
80106448:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010644d:	e9 2b f2 ff ff       	jmp    8010567d <alltraps>
...
80106454:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106459:	e9 1f f2 ff ff       	jmp    8010567d <alltraps>
...
80106460:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106465:	e9 13 f2 ff ff       	jmp    8010567d <alltraps>
...
8010646c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106471:	e9 07 f2 ff ff       	jmp    8010567d <alltraps>
...
80106478:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010647d:	e9 fb f1 ff ff       	jmp    8010567d <alltraps>
...
80106484:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106489:	e9 ef f1 ff ff       	jmp    8010567d <alltraps>
...
80106490:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106495:	e9 e3 f1 ff ff       	jmp    8010567d <alltraps>
...
8010649c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064a1:	e9 d7 f1 ff ff       	jmp    8010567d <alltraps>
...
801064a8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064ad:	e9 cb f1 ff ff       	jmp    8010567d <alltraps>
...
801064b4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064b9:	e9 bf f1 ff ff       	jmp    8010567d <alltraps>
...
801064c0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064c5:	e9 b3 f1 ff ff       	jmp    8010567d <alltraps>
...
801064cc:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064d1:	e9 a7 f1 ff ff       	jmp    8010567d <alltraps>
...
801064d8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064dd:	e9 9b f1 ff ff       	jmp    8010567d <alltraps>
...
801064e4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064e9:	e9 8f f1 ff ff       	jmp    8010567d <alltraps>
...
801064f0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064f5:	e9 83 f1 ff ff       	jmp    8010567d <alltraps>
...
801064fc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106501:	e9 77 f1 ff ff       	jmp    8010567d <alltraps>
...
80106508:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010650d:	e9 6b f1 ff ff       	jmp    8010567d <alltraps>
...
80106514:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106519:	e9 5f f1 ff ff       	jmp    8010567d <alltraps>
...
80106520:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106525:	e9 53 f1 ff ff       	jmp    8010567d <alltraps>
...
8010652c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106531:	e9 47 f1 ff ff       	jmp    8010567d <alltraps>
...
80106538:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010653d:	e9 3b f1 ff ff       	jmp    8010567d <alltraps>
...
80106544:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106549:	e9 2f f1 ff ff       	jmp    8010567d <alltraps>
...
80106550:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106555:	e9 23 f1 ff ff       	jmp    8010567d <alltraps>
...
8010655c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106561:	e9 17 f1 ff ff       	jmp    8010567d <alltraps>
...
80106568:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010656d:	e9 0b f1 ff ff       	jmp    8010567d <alltraps>
...
80106574:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106579:	e9 ff f0 ff ff       	jmp    8010567d <alltraps>
...
80106580:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106585:	e9 f3 f0 ff ff       	jmp    8010567d <alltraps>
...
8010658c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106591:	e9 e7 f0 ff ff       	jmp    8010567d <alltraps>
...
80106602:	e8 39 de ff ff       	call   80104440 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106753:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106756:	e8 35 cf ff ff       	call   80103690 <cpuid>
...
80106810:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106854:	0f 84 c3 00 00 00    	je     8010691d <switchuvm+0xed>
  pushcli();
8010685a:	e8 31 da ff ff       	call   80104290 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010685f:	e8 ac cd ff ff       	call   80103610 <mycpu>
80106864:	89 c3                	mov    %eax,%ebx
80106866:	e8 a5 cd ff ff       	call   80103610 <mycpu>
8010686b:	89 c7                	mov    %eax,%edi
8010686d:	e8 9e cd ff ff       	call   80103610 <mycpu>
80106872:	83 c7 08             	add    $0x8,%edi
80106875:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106878:	e8 93 cd ff ff       	call   80103610 <mycpu>
...
8010690b:	5d                   	pop    %ebp
  popcli();
8010690c:	e9 bf d9 ff ff       	jmp    801042d0 <popcli>
...
80106977:	e8 c4 da ff ff       	call   80104440 <memset>
...
801069ab:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069ac:	e9 2f db ff ff       	jmp    801044e0 <memmove>
...
80106ac3:	e8 78 d9 ff ff       	call   80104440 <memset>
...
80106c3b:	e8 00 d8 ff ff       	call   80104440 <memset>
...
80106cab:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d03:	0f 84 b9 00 00 00    	je     80106dc2 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106d18:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106d1e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d25:	00 
80106d26:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d2a:	89 04 24             	mov    %eax,(%esp)
80106d2d:	e8 ae d7 ff ff       	call   801044e0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106d32:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d35:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d3a:	89 fa                	mov    %edi,%edx
80106d3c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d40:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
...
80106d53:	78 63                	js     80106db8 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106d55:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106d5b:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106d5e:	76 48                	jbe    80106da8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d60:	8b 45 08             	mov    0x8(%ebp),%eax
80106d63:	31 c9                	xor    %ecx,%ecx
80106d65:	89 fa                	mov    %edi,%edx
80106d67:	e8 34 f8 ff ff       	call   801065a0 <walkpgdir>
80106d6c:	85 c0                	test   %eax,%eax
80106d6e:	74 62                	je     80106dd2 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106d70:	8b 00                	mov    (%eax),%eax
80106d72:	a8 01                	test   $0x1,%al
80106d74:	74 50                	je     80106dc6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106d76:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106d78:	25 ff 0f 00 00       	and    $0xfff,%eax
80106d7d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106d80:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106d86:	e8 25 b7 ff ff       	call   801024b0 <kalloc>
80106d8b:	85 c0                	test   %eax,%eax
80106d8d:	89 c3                	mov    %eax,%ebx
80106d8f:	75 87                	jne    80106d18 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106d91:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d94:	89 04 24             	mov    %eax,(%esp)
80106d97:	e8 f4 fd ff ff       	call   80106b90 <freevm>
  return 0;
80106d9c:	31 c0                	xor    %eax,%eax
}
80106d9e:	83 c4 2c             	add    $0x2c,%esp
80106da1:	5b                   	pop    %ebx
80106da2:	5e                   	pop    %esi
80106da3:	5f                   	pop    %edi
80106da4:	5d                   	pop    %ebp
80106da5:	c3                   	ret    
80106da6:	66 90                	xchg   %ax,%ax
80106da8:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106dab:	83 c4 2c             	add    $0x2c,%esp
80106dae:	5b                   	pop    %ebx
80106daf:	5e                   	pop    %esi
80106db0:	5f                   	pop    %edi
80106db1:	5d                   	pop    %ebp
...
80106db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106db8:	89 1c 24             	mov    %ebx,(%esp)
80106dbb:	e8 40 b5 ff ff       	call   80102300 <kfree>
      goto bad;
80106dc0:	eb cf                	jmp    80106d91 <copyuvm+0xa1>
    return 0;
80106dc2:	31 c0                	xor    %eax,%eax
80106dc4:	eb d8                	jmp    80106d9e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106dc6:	c7 04 24 76 78 10 80 	movl   $0x80107876,(%esp)
80106dcd:	e8 8e 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106dd2:	c7 04 24 5c 78 10 80 	movl   $0x8010785c,(%esp)
80106dd9:	e8 82 95 ff ff       	call   80100360 <panic>
...
80106e5c:	e8 7f d6 ff ff       	call   801044e0 <memmove>
    len -= n;
    buf += n;
