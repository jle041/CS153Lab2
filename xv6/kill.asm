 ...
 185:	31 f6                	xor    %esi,%esi
{
 ...
 1a3:	e8 0a 01 00 00       	call   2b2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1f6:	e8 df 00 00 00       	call   2da <open>
  if(fd < 0)
 ...
 20b:	e8 e2 00 00 00       	call   2f2 <fstat>
  close(fd);
 210:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 213:	89 c6                	mov    %eax,%esi
  close(fd);
 215:	e8 a8 00 00 00       	call   2c2 <close>
  return r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	e8 eb fe ff ff       	call   2ba <write>
  while(--i >= 0)
 ...
 3fe:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 433:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 436:	e8 7f fe ff ff       	call   2ba <write>
 ...
 4a6:	e8 0f fe ff ff       	call   2ba <write>
        putc(fd, c);
 ...
 4c0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 4c3:	e8 f2 fd ff ff       	call   2ba <write>
  for(i = 0; fmt[i]; i++){
 ...
 550:	e8 65 fd ff ff       	call   2ba <write>
        while(*s != 0){
 ...
 580:	e8 35 fd ff ff       	call   2ba <write>
 ...
 5d0:	e8 e5 fc ff ff       	call   2ba <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6da:	e8 43 fc ff ff       	call   322 <sbrk>
  if(p == (char*)-1)
