...
_waitpidtest:     file format elf32-i386
...
int main(int argc, char * argv[]){
  ...
  int pid;
  pid = fork();
   a:	e8 ab 02 00 00       	call   2ba <fork>
  if(pid < 0) {
   f:	85 c0                	test   %eax,%eax
  pid = fork();
  11:	89 c3                	mov    %eax,%ebx
  if(pid < 0) {
  13:	78 67                	js     7c <main+0x7c>
    printf(1,"fork dun goofed");
    exit(1);
  }
  else if(pid == 0) {
  15:	74 4f                	je     66 <main+0x66>
    printf(1,"in child");
  }
  else {
    int status = 1;
    printf(1,"in parent");
  17:	c7 44 24 04 9f 07 00 	movl   $0x79f,0x4(%esp)
  1e:	00 
  1f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    int status = 1;
  26:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  2d:	00 
    printf(1,"in parent");
  2e:	e8 ed 03 00 00       	call   420 <printf>
    waitpid(pid,&status,0);
  33:	8d 44 24 1c          	lea    0x1c(%esp),%eax
  37:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  3e:	00 
  3f:	89 44 24 04          	mov    %eax,0x4(%esp)
  43:	89 1c 24             	mov    %ebx,(%esp)
  46:	e8 87 02 00 00       	call   2d2 <waitpid>
  }

  //int status = 1;
  //waitpid(pid,&status,0);
  printf(1,"waitpid ended, child exited");
  4b:	c7 44 24 04 a9 07 00 	movl   $0x7a9,0x4(%esp)
  52:	00 
  ...
  65:	c3                   	ret    
    printf(1,"in child");
  66:	c7 44 24 04 96 07 00 	movl   $0x796,0x4(%esp)
  6d:	00 
  6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  75:	e8 a6 03 00 00       	call   420 <printf>
  7a:	eb cf                	jmp    4b <main+0x4b>
    printf(1,"fork dun goofed");
  7c:	c7 44 24 04 86 07 00 	movl   $0x786,0x4(%esp)
  83:	00 
  84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8b:	e8 90 03 00 00       	call   420 <printf>
    exit(1);
  90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  97:	e8 26 02 00 00       	call   2c2 <exit>
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
 ...
 1b5:	31 f6                	xor    %esi,%esi
{
 ...
 1d3:	e8 0a 01 00 00       	call   2e2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 226:	e8 df 00 00 00       	call   30a <open>
  if(fd < 0)
 ...
 23b:	e8 e2 00 00 00       	call   322 <fstat>
  close(fd);
 240:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 243:	89 c6                	mov    %eax,%esi
  close(fd);
 245:	e8 a8 00 00 00       	call   2f2 <close>
  return r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	e8 eb fe ff ff       	call   2ea <write>
  while(--i >= 0)
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 463:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 466:	e8 7f fe ff ff       	call   2ea <write>
 ...
 4d6:	e8 0f fe ff ff       	call   2ea <write>
        putc(fd, c);
 ...
 4f0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 4f3:	e8 f2 fd ff ff       	call   2ea <write>
  for(i = 0; fmt[i]; i++){
 ...
 54f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 551:	b8 c5 07 00 00       	mov    $0x7c5,%eax
 ...
 580:	e8 65 fd ff ff       	call   2ea <write>
        while(*s != 0){
 ...
 5b0:	e8 35 fd ff ff       	call   2ea <write>
 ...
 600:	e8 e5 fc ff ff       	call   2ea <write>
        ap++;
 ...
 611:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 682:	a3 50 0a 00 00       	mov    %eax,0xa50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 50 0a 00 00    	mov    0xa50,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 50 0a 00 00    	cmp    0xa50,%edx
 ...
 70a:	e8 43 fc ff ff       	call   352 <sbrk>
  if(p == (char*)-1)
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 50 0a 00 00    	mov    0xa50,%edx
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 747:	89 15 50 0a 00 00    	mov    %edx,0xa50
      return (void*)(p + 1);
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 54 0a 00 00       	mov    $0xa54,%edx
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 774:	0a 00 00 
    base.s.size = 0;
 777:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 77e:	00 00 00 
